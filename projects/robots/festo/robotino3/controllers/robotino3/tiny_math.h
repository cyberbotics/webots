...
void matrix33_mult_vector3(Vector3 *res, const Matrix33 *m,
                           const Vector3 *v); // res = m * v

// --- Vector2 functions ---
void vector2_minus(Vector2 *v, const Vector2 *v1,
                   const Vector2 *v2); // v = v1-v2
double vector2_norm(const Vector2 *v); // ||v||
double vector2_angle(const Vector2 *v1,
                     const Vector2 *v2); // angle between v1 and v2 -> [0, 2Pi]
