...
int main() {
  ...
  WbDeviceTag motor_fl = wb_robot_get_device("wheel2");
  WbDeviceTag motor_fr = wb_robot_get_device("wheel1");
  WbDeviceTag motor_bl = wb_robot_get_device("wheel4");
  WbDeviceTag motor_br = wb_robot_get_device("wheel3");
