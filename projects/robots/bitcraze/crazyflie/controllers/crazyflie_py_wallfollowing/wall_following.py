...
class WallFollowing():
    ...
    def wall_follower(self, front_range, side_range, current_heading,
        ...
        if self.state_wf == self.StateWF.FORWARD:
        ...
        elif self.state_wf == self.StateWF.HOVER:
            print('hover')
        elif self.state_wf == self.StateWF.TURN_TO_FIND_WALL:
        ...
        elif self.state_wf == self.StateWF.TURN_TO_ALIGN_TO_WALL:
        ...
        elif self.state_wf == self.StateWF.FORWARD_ALONG_WALL:
        ...
        elif self.state_wf == self.StateWF.ROTATE_AROUND_WALL:
            if front_range < self.ref_distance_from_wall + self.ranger_value_buffer:
                self.state_wf = self.transition(self.StateWF.TURN_TO_FIND_WALL)
        elif self.state_wf == self.StateWF.ROTATE_IN_CORNER:
            ...
            if check_heading_corner:
                self.state_wf = self.transition(self.StateWF.TURN_TO_FIND_WALL)
        elif self.state_wf == self.StateWF.FIND_CORNER:
