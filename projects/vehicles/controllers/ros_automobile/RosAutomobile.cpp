...
void RosAutomobile::launchRos(int argc, char **argv) {
  ...
  mGetIndicatorServer =
    nodeHandle()->advertiseService("automobile/get_indicator", &RosAutomobile::getIndicatorCallback, this);
  mGetIndicatorPeriodServer = nodeHandle()->advertiseService("automobile/get_indicator_period",
  ...
  mGetWiperModeServer =
    nodeHandle()->advertiseService("automobile/get_wiper_mode", &RosAutomobile::getWiperModeCallback, this);
  ...
  mSetBrakeServer =
    nodeHandle()->advertiseService("automobile/set_brake_intensity", &RosAutomobile::setBrakeCallback, this);
  ...
  mSetIndicatorServer =
    nodeHandle()->advertiseService("automobile/set_indicator", &RosAutomobile::setIndicatorCallback, this);
  mSetIndicatorPeriodServer = nodeHandle()->advertiseService("automobile/set_indicator_period",
  ...
  mSetThrottleServer =
    nodeHandle()->advertiseService("automobile/set_throttle", &RosAutomobile::setThrottleCallback, this);
  mSetWiperModeServer =
    nodeHandle()->advertiseService("automobile/set_wiper_mode", &RosAutomobile::setWiperModeCallback, this);
  ...
  mRightSteeringAnglePublisher =
    nodeHandle()->advertise<webots_ros::Float64Stamped>("automobile/right_steering_angle", 1);
  mLeftSteeringAnglePublisher =
    nodeHandle()->advertise<webots_ros::Float64Stamped>("automobile/left_steering_angle", 1);
  mThrottlePublisher = nodeHandle()->advertise<webots_ros::Float64Stamped>("automobile/throttle", 1);
  mWheelEncoderPublisher[0] =
    nodeHandle()->advertise<webots_ros::Float64Stamped>("automobile/front_right_wheel_encoder", 1);
  mWheelEncoderPublisher[1] =
    nodeHandle()->advertise<webots_ros::Float64Stamped>("automobile/front_left_wheel_encoder", 1);
  mWheelEncoderPublisher[2] =
    nodeHandle()->advertise<webots_ros::Float64Stamped>("automobile/rear_right_wheel_encoder", 1);
  mWheelEncoderPublisher[3] =
    nodeHandle()->advertise<webots_ros::Float64Stamped>("automobile/rear_left_wheel_encoder", 1);
  mWheelSpeedPublisher[0] =
    nodeHandle()->advertise<webots_ros::Float64Stamped>("automobile/front_right_wheel_speed", 1);
  mWheelSpeedPublisher[1] =
    nodeHandle()->advertise<webots_ros::Float64Stamped>("automobile/front_left_wheel_speed", 1);
  mWheelSpeedPublisher[2] =
    nodeHandle()->advertise<webots_ros::Float64Stamped>("automobile/rear_right_wheel_speed", 1);
  mWheelSpeedPublisher[3] =
    nodeHandle()->advertise<webots_ros::Float64Stamped>("automobile/rear_left_wheel_speed", 1);
}
