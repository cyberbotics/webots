...
RosBrake::RosBrake(Brake *brake, Ros *ros) : RosDevice(brake, ros) {
  ...
  mSetDampingConstantServer = RosDevice::rosAdvertiseService(fixedDeviceName + "/set_damping_constant",
                                                             &RosBrake::setDampingConstantCallback);
  mGetTypeServer =
    RosDevice::rosAdvertiseService(fixedDeviceName + "/get_type", &RosBrake::getTypeCallback);
  mGetMotorNameServer =
    RosDevice::rosAdvertiseService(fixedDeviceName + "/get_motor_name", &RosBrake::getMotorNameCallback);
  mGetPositionSensorNameServer = RosDevice::rosAdvertiseService(
    fixedDeviceName + "/get_position_sensor_name", &RosBrake::getPositionSensorNameCallback);
  mBrake = brake;
}
