...
RosEmitter::RosEmitter(Emitter *emitter, Ros *ros) : RosDevice(emitter, ros) {
  ...
  mGetBufferSizeServer = RosDevice::rosAdvertiseService(fixedDeviceName + "/get_buffer_size",
                                                        &RosEmitter::getBufferSizeCallback);
  mGetChannelServer =
    RosDevice::rosAdvertiseService(fixedDeviceName + "/get_channel", &RosEmitter::getChannelCallback);
  mGetRangeServer =
    RosDevice::rosAdvertiseService(fixedDeviceName + "/get_range", &RosEmitter::getRangeCallback);
  mSetChannelServer =
    RosDevice::rosAdvertiseService(fixedDeviceName + "/set_channel", &RosEmitter::setChannelCallback);
  mSetRangeServer =
    RosDevice::rosAdvertiseService(fixedDeviceName + "/set_range", &RosEmitter::setRangeCallback);
}
