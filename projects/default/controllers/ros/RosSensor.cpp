...
RosSensor::RosSensor(std::string deviceName, Device *device, Ros *ros, bool enableDefaultServices) :
  ...
  mSensorEnableServer =
    RosDevice::rosAdvertiseService(fixedDeviceName + "/enable", &RosSensor::sensorEnableCallback);
  mSamplingPeriodServer = RosDevice::rosAdvertiseService(fixedDeviceName + "/get_sampling_period",
