...
RosSupervisor::RosSupervisor(Ros *ros, Supervisor *supervisor) {
  ...
  mSimulationQuitServer = mRos->nodeHandle()->advertiseService("supervisor/simulation_quit",
                                                               &RosSupervisor::simulationQuitCallback, this);
  mSimulationRevertServer = mRos->nodeHandle()->advertiseService("supervisor/simulation_revert",
                                                                 &RosSupervisor::simulationRevertCallback, this);
  mSimulationResetServer = mRos->nodeHandle()->advertiseService("supervisor/simulation_reset",
  ...
  mSimulationGetModeServer = mRos->nodeHandle()->advertiseService("supervisor/simulation_get_mode",
                                                                  &RosSupervisor::simulationGetModeCallback, this);
  mSimulationSetModeServer = mRos->nodeHandle()->advertiseService("supervisor/simulation_set_mode",
                                                                  &RosSupervisor::simulationSetModeCallback, this);
  mWorldLoadServer =
    mRos->nodeHandle()->advertiseService("supervisor/world_load", &RosSupervisor::worldLoadCallback, this);
  mWorldSaveServer =
    mRos->nodeHandle()->advertiseService("supervisor/world_save", &RosSupervisor::worldSaveCallback, this);
  mWorldReloadServer =
  ...
  mMovieStartRecordingServer = mRos->nodeHandle()->advertiseService("supervisor/movie_start_recording",
                                                                    &RosSupervisor::movieStartRecordingCallback, this);
  mMovieStopRecordingServer = mRos->nodeHandle()->advertiseService("supervisor/movie_stop_recording",
                                                                   &RosSupervisor::movieStopRecordingCallback, this);
  mMovieFailedServer = mRos->nodeHandle()->advertiseService("supervisor/movie_failed",
                                                            &RosSupervisor::movieFailedCallback, this);
  mMovieIsReadyServer = mRos->nodeHandle()->advertiseService("supervisor/movie_is_ready",
                                                             &RosSupervisor::movieIsReadyCallback, this);
  mSetLabelServer =
    mRos->nodeHandle()->advertiseService("supervisor/set_label", &RosSupervisor::setLabelCallback, this);
  mGetRootServer =
    mRos->nodeHandle()->advertiseService("supervisor/get_root", &RosSupervisor::getRootCallback, this);
  mGetSelfServer =
    mRos->nodeHandle()->advertiseService("supervisor/get_self", &RosSupervisor::getSelfCallback, this);
  mGetFromDefServer =
    mRos->nodeHandle()->advertiseService("supervisor/get_from_def", &RosSupervisor::getFromDefCallback, this);
  mGetFromIdServer =
    mRos->nodeHandle()->advertiseService("supervisor/get_from_id", &RosSupervisor::getFromIdCallback, this);
  mGetFromDeviceServer = mRos->nodeHandle()->advertiseService("supervisor/get_from_device",
  ...
  mVirtualRealityHeadsetGetOrientationServer =
    mRos->nodeHandle()->advertiseService("supervisor/vitual_reality_headset_get_orientation",
                                         &RosSupervisor::virtualRealityHeadsetGetOrientationCallback, this);
  mVirtualRealityHeadsetGetPositionServer =
    mRos->nodeHandle()->advertiseService("supervisor/vitual_reality_headset_get_position",
  ...
  mVirtualRealityHeadsetIsUsedServer = mRos->nodeHandle()->advertiseService(
    "supervisor/vitual_reality_headset_is_used", &RosSupervisor::virtualRealityHeadsetIsUsedCallback, this);

  mNodeGetContactPointServer = mRos->nodeHandle()->advertiseService("supervisor/node/get_contact_points",
                                                                    &RosSupervisor::nodeGetContactPointsCallback, this);
  mNodeEnableContactPointsTrackingServer =
    mRos->nodeHandle()->advertiseService("supervisor/node/enable_contact_point_tracking",
                                         &RosSupervisor::nodeEnableContactPointsTrackingCallback, this);
  mNodeDisableContactPointsTrackingServer =
    mRos->nodeHandle()->advertiseService("supervisor/node/disable_contact_points_tracking",
                                         &RosSupervisor::nodeDisableContactPointsTrackingCallback, this);

  mNodeGetIdServer =
    mRos->nodeHandle()->advertiseService("supervisor/node/get_id", &RosSupervisor::nodeGetIdCallback, this);
  mNodeGetTypeServer = mRos->nodeHandle()->advertiseService("supervisor/node/get_type",
                                                            &RosSupervisor::nodeGetTypeCallback, this);
  mNodeGetTypeNameServer = mRos->nodeHandle()->advertiseService("supervisor/node/get_type_name",
                                                                &RosSupervisor::nodeGetTypeNameCallback, this);
  mNodeGetDefServer =
    mRos->nodeHandle()->advertiseService("supervisor/node/get_def", &RosSupervisor::nodeGetDefCallback, this);
  ...
  mNodeGetParentNodeServer = mRos->nodeHandle()->advertiseService("supervisor/node/get_parent_node",
                                                                  &RosSupervisor::nodeGetParentNodeCallback, this);
  mNodeIsProtoServer = mRos->nodeHandle()->advertiseService("supervisor/node/is_proto",
                                                            &RosSupervisor::nodeIsProtoCallback, this);
  mNodeGetPositionServer = mRos->nodeHandle()->advertiseService("supervisor/node/get_position",
                                                                &RosSupervisor::nodeGetPositionCallback, this);
  mNodeGetOrientationServer = mRos->nodeHandle()->advertiseService("supervisor/node/get_orientation",
                                                                   &RosSupervisor::nodeGetOrientationCallback, this);
  mNodeGetPoseServer = mRos->nodeHandle()->advertiseService("supervisor/node/get_pose",
  ...
  mNodeGetNumberOfContactPointsServer =
    mRos->nodeHandle()->advertiseService("supervisor/node/get_number_of_contact_points",
                                         &RosSupervisor::nodeGetNumberOfContactPointsCallback, this);
  mNodeGetContactPointServer = mRos->nodeHandle()->advertiseService("supervisor/node/get_contact_point",
                                                                    &RosSupervisor::nodeGetContactPointCallback, this);
  mNodeGetContactPointNodeServer = mRos->nodeHandle()->advertiseService(
    "supervisor/node/get_contact_point_node", &RosSupervisor::nodeGetContactPointNodeCallback, this);
  ...
  mNodeGetVelocityServer = mRos->nodeHandle()->advertiseService("supervisor/node/get_velocity",
                                                                &RosSupervisor::nodeGetVelocityCallback, this);
  mNodeSetVelocityServer = mRos->nodeHandle()->advertiseService("supervisor/node/set_velocity",
                                                                &RosSupervisor::nodeSetVelocityCallback, this);
  mNodeAddForceServer = mRos->nodeHandle()->advertiseService("supervisor/node/add_force",
  ...
  mNodeAddTorqueServer = mRos->nodeHandle()->advertiseService("supervisor/node/add_torque",
                                                              &RosSupervisor::nodeAddTorqueCallback, this);
  mNodeGetFieldServer = mRos->nodeHandle()->advertiseService("supervisor/node/get_field",
  ...
  mNodeMoveViewpointServer = mRos->nodeHandle()->advertiseService("supervisor/node/move_viewpoint",
                                                                  &RosSupervisor::nodeMoveViewpointCallback, this);
  mNodeSetVisibilityServer = mRos->nodeHandle()->advertiseService("supervisor/node/set_visibility",
                                                                  &RosSupervisor::nodeSetVisibilityCallback, this);
  mNodeRemoveServer =
    mRos->nodeHandle()->advertiseService("supervisor/node/remove", &RosSupervisor::nodeRemoveCallback, this);
  mNodeExportStringServer = mRos->nodeHandle()->advertiseService("supervisor/node/export_string",
                                                                 &RosSupervisor::nodeExportStringCallback, this);
  mNodeResetPhysicsServer = mRos->nodeHandle()->advertiseService("supervisor/node/reset_physics",
                                                                 &RosSupervisor::nodeResetPhysicsCallback, this);
  mNodeSaveStateServer = mRos->nodeHandle()->advertiseService("supervisor/node/save_state",
                                                              &RosSupervisor::nodeSaveStateCallback, this);
  mNodeLoadStateServer = mRos->nodeHandle()->advertiseService("supervisor/node/load_state",
  ...
  mNodeDisablePoseTrackingServer = mRos->nodeHandle()->advertiseService(
    "supervisor/node/disable_pose_tracking", &RosSupervisor::nodeDisablePoseTrackingCallback, this);
  ...
  mFieldGetNameServer = mRos->nodeHandle()->advertiseService("supervisor/field/get_name",
                                                             &RosSupervisor::fieldGetNameCallback, this);
  mFieldGetTypeServer = mRos->nodeHandle()->advertiseService("supervisor/field/get_type",
                                                             &RosSupervisor::fieldGetTypeCallback, this);
  mFieldGetTypeNameServer = mRos->nodeHandle()->advertiseService("supervisor/field/get_type_name",
                                                                 &RosSupervisor::fieldGetTypeNameCallback, this);
  mFieldGetCountServer = mRos->nodeHandle()->advertiseService("supervisor/field/get_count",
                                                              &RosSupervisor::fieldGetCountCallback, this);
  mFieldGetBoolServer = mRos->nodeHandle()->advertiseService("supervisor/field/get_bool",
                                                             &RosSupervisor::fieldGetBoolCallback, this);
  mFieldGetInt32Server = mRos->nodeHandle()->advertiseService("supervisor/field/get_int32",
                                                              &RosSupervisor::fieldGetInt32Callback, this);
  mFieldGetFloatServer = mRos->nodeHandle()->advertiseService("supervisor/field/get_float",
                                                              &RosSupervisor::fieldGetFloatCallback, this);
  mFieldGetVec2fServer = mRos->nodeHandle()->advertiseService("supervisor/field/get_vec2f",
                                                              &RosSupervisor::fieldGetVec2fCallback, this);
  mFieldGetVec3fServer = mRos->nodeHandle()->advertiseService("supervisor/field/get_vec3f",
                                                              &RosSupervisor::fieldGetVec3fCallback, this);
  mFieldGetRotationServer = mRos->nodeHandle()->advertiseService("supervisor/field/get_rotation",
                                                                 &RosSupervisor::fieldGetRotationCallback, this);
  mFieldGetColorServer = mRos->nodeHandle()->advertiseService("supervisor/field/get_color",
                                                              &RosSupervisor::fieldGetColorCallback, this);
  mFieldGetStringServer = mRos->nodeHandle()->advertiseService("supervisor/field/get_string",
                                                               &RosSupervisor::fieldGetStringCallback, this);
  mFieldGetNodeServer = mRos->nodeHandle()->advertiseService("supervisor/field/get_node",
                                                             &RosSupervisor::fieldGetNodeCallback, this);
  mFieldSetBoolServer = mRos->nodeHandle()->advertiseService("supervisor/field/set_bool",
                                                             &RosSupervisor::fieldSetBoolCallback, this);
  mFieldSetInt32Server = mRos->nodeHandle()->advertiseService("supervisor/field/set_int32",
                                                              &RosSupervisor::fieldSetInt32Callback, this);
  mFieldSetFloatServer = mRos->nodeHandle()->advertiseService("supervisor/field/set_float",
                                                              &RosSupervisor::fieldSetFloatCallback, this);
  mFieldSetVec2fServer = mRos->nodeHandle()->advertiseService("supervisor/field/set_vec2f",
                                                              &RosSupervisor::fieldSetVec2fCallback, this);
  mFieldSetVec3fServer = mRos->nodeHandle()->advertiseService("supervisor/field/set_vec3f",
                                                              &RosSupervisor::fieldSetVec3fCallback, this);
  mFieldSetRotationServer = mRos->nodeHandle()->advertiseService("supervisor/field/set_rotation",
                                                                 &RosSupervisor::fieldSetRotationCallback, this);
  mFieldSetColorServer = mRos->nodeHandle()->advertiseService("supervisor/field/set_color",
                                                              &RosSupervisor::fieldSetColorCallback, this);
  mFieldSetStringServer = mRos->nodeHandle()->advertiseService("supervisor/field/set_string",
                                                               &RosSupervisor::fieldSetStringCallback, this);
  mFieldInsertBoolServer = mRos->nodeHandle()->advertiseService("supervisor/field/insert_bool",
                                                                &RosSupervisor::fieldInsertBoolCallback, this);
  mFieldInsertInt32Server = mRos->nodeHandle()->advertiseService("supervisor/field/insert_int32",
                                                                 &RosSupervisor::fieldInsertInt32Callback, this);
  mFieldInsertFloatServer = mRos->nodeHandle()->advertiseService("supervisor/field/insert_float",
                                                                 &RosSupervisor::fieldInsertFloatCallback, this);
  mFieldInsertVec2fServer = mRos->nodeHandle()->advertiseService("supervisor/field/insert_vec2f",
                                                                 &RosSupervisor::fieldInsertVec2fCallback, this);
  mFieldInsertVec3fServer = mRos->nodeHandle()->advertiseService("supervisor/field/insert_vec3f",
                                                                 &RosSupervisor::fieldInsertVec3fCallback, this);
  mFieldInsertRotationServer = mRos->nodeHandle()->advertiseService("supervisor/field/insert_rotation",
                                                                    &RosSupervisor::fieldInsertRotationCallback, this);
  mFieldInsertColorServer = mRos->nodeHandle()->advertiseService("supervisor/field/insert_color",
                                                                 &RosSupervisor::fieldInsertColorCallback, this);
  mFieldInsertStringServer = mRos->nodeHandle()->advertiseService("supervisor/field/insert_string",
  ...
  mFieldImportNodeServer = mRos->nodeHandle()->advertiseService("supervisor/field/import_node",
  ...
  mFieldRemoveNodeServer = mRos->nodeHandle()->advertiseService("supervisor/field/remove_node",
