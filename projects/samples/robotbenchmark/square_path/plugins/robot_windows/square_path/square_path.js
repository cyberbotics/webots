...
webots.window('square_path').receive = function(message, robot) {
  ...
  if (message.startsWith('update:')) {
    ...
    performance = parseFloat(message.substr(segmentIndex));
    $('#average-display').html(metricToString(performance));
  ...
  // adds a point to the path
    ...
    if (typeof sendBenchmarkRecord === "undefined" || !sendBenchmarkRecord(robot, this, benchmarkName, performance, metricToString)) {
