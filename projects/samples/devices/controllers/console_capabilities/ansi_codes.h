...
// Convenient macros
#define PRINT_IN_BLACK(x) puts(ANSI_COLOR_FG_BLACK x ANSI_COLOR_RESET)
#define PRINT_IN_RED(x) puts(ANSI_COLOR_FG_RED x ANSI_COLOR_RESET)
#define PRINT_IN_GREEN(x) puts(ANSI_COLOR_FG_GREEN x ANSI_COLOR_RESET)
#define PRINT_IN_YELLOW(x) puts(ANSI_COLOR_FG_YELLOW x ANSI_COLOR_RESET)
#define PRINT_IN_BLUE(x) puts(ANSI_COLOR_FG_BLUE x ANSI_COLOR_RESET)
#define PRINT_IN_MAGENTA(x) puts(ANSI_COLOR_FG_MAGENTA x ANSI_COLOR_RESET)
#define PRINT_IN_CYAN(x) puts(ANSI_COLOR_FG_CYAN x ANSI_COLOR_RESET)
#define PRINT_IN_WHITE(x) puts(ANSI_COLOR_FG_WHITE x ANSI_COLOR_RESET)
