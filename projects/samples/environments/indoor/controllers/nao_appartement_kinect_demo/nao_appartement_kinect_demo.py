...
class Sprinter(Robot):
    ...
    def initialize(self):
        ...
        self.kinectCamera = self.getCamera('kinect color')
        self.kinectCamera.enable(32)
        self.depthCamera = self.getRangeFinder('kinect range')
        self.depthCamera.enable(32)
    ...
    def run(self):
        ...
        while True:
            ...
            # # Get the kinect depth and color images
            # image = self.kinectCamera.getImageArray()
            # depth = self.depthCamera.getRangeImageArray()
