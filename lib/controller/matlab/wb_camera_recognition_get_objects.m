...
if rate <= 0
    targets = []
    calllib('libController', 'wb_console_print', 'Warning: wb_camera_recognition_get_objects() called for a disabled device! Please use: wb_camera_recognition_enable() before.', 1);
else
