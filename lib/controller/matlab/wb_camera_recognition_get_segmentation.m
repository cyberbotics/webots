function rgb = wb_camera_recognition_get_segmentation(tag)
% Usage: wb_camera_recognition_get_segmentation(tag)
...
pointer = calllib('libController', 'wb_camera_recognition_get_segmentation',tag);
