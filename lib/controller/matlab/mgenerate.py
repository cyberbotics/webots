...
gen(PROC, "wb_supervisor_node_add_force(noderef, force)", "supervisor")
gen(PROC, "wb_supervisor_node_add_relative_force(noderef, force, origin)", "supervisor")
gen(PROC, "wb_supervisor_node_add_torque(noderef, torque)", "supervisor")
