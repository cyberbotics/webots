...
# ANSI codes
gen_const("ANSI_RESET", "\x1b[0m")
gen_const("ANSI_BOLD", "\x1b[1m")
gen_const("ANSI_UNDERLINE", "\x1b[4m")
gen_const("ANSI_BLACK_FOREGROUND", "\x1b[30m")
gen_const("ANSI_RED_FOREGROUND", "\x1b[31m")
gen_const("ANSI_GREEN_FOREGROUND", "\x1b[32m")
gen_const("ANSI_YELLOW_FOREGROUND", "\x1b[33m")
gen_const("ANSI_BLUE_FOREGROUND", "\x1b[34m")
gen_const("ANSI_MAGENTA_FOREGROUND", "\x1b[35m")
gen_const("ANSI_CYAN_FOREGROUND", "\x1b[36m")
gen_const("ANSI_WHITE_FOREGROUND", "\x1b[37m")
gen_const("ANSI_BLACK_BACKGROUND", "\x1b[40m")
gen_const("ANSI_RED_BACKGROUND", "\x1b[41m")
gen_const("ANSI_GREEN_BACKGROUND", "\x1b[42m")
gen_const("ANSI_YELLOW_BACKGROUND", "\x1b[43m")
gen_const("ANSI_BLUE_BACKGROUND", "\x1b[44m")
gen_const("ANSI_MAGENTA_BACKGROUND", "\x1b[45m")
gen_const("ANSI_CYAN_BACKGROUND", "\x1b[46m")
gen_const("ANSI_WHITE_BACKGROUND", "\x1b[47m")
gen_const("ANSI_CLEAR_SCREEN", "\x1b[2J")
...
gen_consts_from_list("""
    ...
    """)
gen_consts_from_list('WB_SUPERVISOR_SIMULATION_MODE_PAUSE, WB_SUPERVISOR_SIMULATION_MODE_REAL_TIME, WB_SUPERVISOR_SIMULATION_MODE_RUN, WB_SUPERVISOR_SIMULATION_MODE_FAST')
