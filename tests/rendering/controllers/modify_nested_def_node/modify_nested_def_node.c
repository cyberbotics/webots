...
int main(int argc, char **argv) {
  ...
  WbDeviceTag ds_def1 = wb_robot_get_device("ds1");
  WbDeviceTag ds_use1 = wb_robot_get_device("ds2");
  WbDeviceTag ds_def2 = wb_robot_get_device("ds3");
  WbDeviceTag ds_use2 = wb_robot_get_device("ds4");
  ...
  ts_assert_double_in_delta(use2, 500.0, 1.0, "The size of of USE node containing box B2 is wrong after modifying it.");
