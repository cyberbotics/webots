...
// The mirror camera should be open in the external rendering device window to test that the rendering in the external window doesn't affect the main rendering.
