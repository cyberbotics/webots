...
int main(int argc, char **argv) {
  ...
  const double *ball_joint_marker_pos = wb_supervisor_node_get_position(ball_joint_marker);
  ts_assert_vec3_in_delta(ball_joint_marker_pos[0], ball_joint_marker_pos[1], ball_joint_marker_pos[2],
                          0.129531, 0.155783, 0.223086,
                          0.001, "Final position of the targets not at the expected position.");
