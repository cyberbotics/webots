...
int main(int argc, char **argv) {
  ...
  // SliderJoint Tests -------------------------------------------------------------------------------------------------
  WbDeviceTag slider_joint_motor_lower_limit = wb_robot_get_device("slider_joint_motor_lower_limit");

  // for motor: [minPosition, maxPosition] was [-0.1, 0.1] in world, should be [-0.2, 0.1] after loading
  ts_assert_double_equal(
    wb_motor_get_min_position(slider_joint_motor_lower_limit), -0.2,
    "'minPosition' of SliderJoint (for motor) didn't adjust correctly when position is below lower limit.");
  ts_assert_double_equal(wb_motor_get_max_position(slider_joint_motor_lower_limit), 0.1,
                         "'maxPosition' of SliderJoint (for motor) changed but shouldn't, lower limit being tested.");

  WbDeviceTag slider_joint_motor_upper_limit = wb_robot_get_device("slider_joint_motor_upper_limit");
  ...
  // HingeJoint Tests --------------------------------------------------------------------------------------------------
  WbDeviceTag hinge_joint_motor_lower_limit = wb_robot_get_device("hinge_joint_motor_lower_limit");
  ...
  ts_assert_double_equal(wb_motor_get_max_position(hinge_joint_motor_lower_limit), 0.1,
                         "'maxPosition' of HingeJoint (for motor) changed but shouldn't, lower limit being tested.");

  WbDeviceTag hinge_joint_motor_upper_limit = wb_robot_get_device("hinge_joint_motor_upper_limit");
  ...
  ts_assert_double_equal(wb_motor_get_max_position(hinge_joint_motor_upper_limit), 0.2,
                         "'maxPosition' of HingeJoint (for motor) didn't adjust correctly when position is above upper limit.");

  // Hinge2Joint Tests -------------------------------------------------------------------------------------------------
  WbDeviceTag hinge_2_joint_motor_lower_limit = wb_robot_get_device("hinge_2_joint_motor_lower_limit");
  WbDeviceTag hinge_2_joint_motor2_lower_limit = wb_robot_get_device("hinge_2_joint_motor2_lower_limit");

  // for motor: [minPosition, maxPosition] was [-0.1, 0.1] in world, should be [-0.2, 0.1] after loading
  ts_assert_double_equal(
    wb_motor_get_min_position(hinge_2_joint_motor_lower_limit), -0.2,
    "'minPosition' of Hinge2Joint (for motor) didn't adjust correctly when position is below lower limit.");
  ts_assert_double_equal(wb_motor_get_max_position(hinge_2_joint_motor_lower_limit), 0.1,
  ...
  ts_assert_double_equal(
    wb_motor_get_min_position(hinge_2_joint_motor2_lower_limit), -0.3,
    "'minPosition' of Hinge2Joint (for motor2) didn't adjust correctly when position is below lower limit.");
  ts_assert_double_equal(wb_motor_get_max_position(hinge_2_joint_motor2_lower_limit), 0.1,
                         "'maxPosition' of Hinge2Joint (for motor2) changed but shouldn't, lower limit being tested.");

  WbDeviceTag hinge_2_joint_motor_upper_limit = wb_robot_get_device("hinge_2_joint_motor_upper_limit");
  WbDeviceTag hinge_2_joint_motor2_upper_limit = wb_robot_get_device("hinge_2_joint_motor2_upper_limit");
  ...
  ts_assert_double_equal(wb_motor_get_min_position(hinge_2_joint_motor2_upper_limit), -0.1,
                         "'minPosition' of Hinge2Joint (for motor2) changed but shouldn't, upper limit being tested.");
  ts_assert_double_equal(
    wb_motor_get_max_position(hinge_2_joint_motor2_upper_limit), 0.3,
    "'maxPosition' of Hinge2Joint (for motor2) didn't adjust correctly when position is above lower limit.");

  // BallJoint Tests ---------------------------------------------------------------------------------------------------
  WbDeviceTag ball_joint_motor_lower_limit = wb_robot_get_device("ball_joint_motor_lower_limit");
  WbDeviceTag ball_joint_motor2_lower_limit = wb_robot_get_device("ball_joint_motor2_lower_limit");
  WbDeviceTag ball_joint_motor3_lower_limit = wb_robot_get_device("ball_joint_motor3_lower_limit");
  ...
  // for motor2: [minPosition, maxPosition] was [-0.1, 0.1] in world, should be [-0.3, 0.1] after loading
  ts_assert_double_equal(wb_motor_get_min_position(ball_joint_motor2_lower_limit), -0.3,
                         "'minPosition' of BallJoint (for motor2) didn't adjust correctly when position is below lower limit.");
  ts_assert_double_equal(wb_motor_get_max_position(ball_joint_motor2_lower_limit), 0.1,
  ...
  ts_assert_double_equal(wb_motor_get_min_position(ball_joint_motor3_lower_limit), -0.4,
                         "'minPosition' of BallJoint (for motor3) didn't adjust correctly when position is below lower limit.");
  ts_assert_double_equal(wb_motor_get_max_position(ball_joint_motor3_lower_limit), 0.1,
                         "'maxPosition' of BallJoint (for motor3) changed but shouldn't, lower limit being tested.");

  WbDeviceTag ball_joint_motor_upper_limit = wb_robot_get_device("ball_joint_motor_upper_limit");
  WbDeviceTag ball_joint_motor2_upper_limit = wb_robot_get_device("ball_joint_motor2_upper_limit");
  WbDeviceTag ball_joint_motor3_upper_limit = wb_robot_get_device("ball_joint_motor3_upper_limit");
  ...
  // for motor2: [minPosition, maxPosition] was [-0.1, 0.1] in world, should be [-0.1, 0.3] after loading
  ts_assert_double_equal(wb_motor_get_min_position(ball_joint_motor2_upper_limit), -0.1,
                         "'minPosition' of BallJoint (for motor2) changed but shouldn't, upper limit being tested.");
  ts_assert_double_equal(wb_motor_get_max_position(ball_joint_motor2_upper_limit), 0.3,
  ...
  ts_assert_double_equal(wb_motor_get_min_position(ball_joint_motor3_upper_limit), -0.1,
                         "'minPosition' of BallJoint (for motor3) changed but shouldn't, upper limit being tested.");
  ts_assert_double_equal(wb_motor_get_max_position(ball_joint_motor3_upper_limit), 0.4,
