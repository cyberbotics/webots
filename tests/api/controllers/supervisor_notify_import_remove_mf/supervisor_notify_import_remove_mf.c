...
int main(int argc, char **argv) {
  ...
  mfField[0] = wb_supervisor_node_get_parameter(node, "bool");
  mfField[1] = wb_supervisor_node_get_parameter(node, "int");
  mfField[2] = wb_supervisor_node_get_parameter(node, "float");
  mfField[3] = wb_supervisor_node_get_parameter(node, "vec2");
  mfField[4] = wb_supervisor_node_get_parameter(node, "vec3");
  mfField[5] = wb_supervisor_node_get_parameter(node, "rot");
  mfField[6] = wb_supervisor_node_get_parameter(node, "color");
  mfField[7] = wb_supervisor_node_get_parameter(node, "string");
  WbFieldRef mfProtoFields[FIELD_COUNT];
  mfProtoFields[0] = wb_supervisor_proto_get_parameter(baseProto, "bool");
  mfProtoFields[1] = wb_supervisor_proto_get_parameter(baseProto, "int");
  mfProtoFields[2] = wb_supervisor_proto_get_parameter(baseProto, "float");
  mfProtoFields[3] = wb_supervisor_proto_get_parameter(baseProto, "vec2");
  mfProtoFields[4] = wb_supervisor_proto_get_parameter(baseProto, "vec3");
  mfProtoFields[5] = wb_supervisor_proto_get_parameter(baseProto, "rot");
  mfProtoFields[6] = wb_supervisor_proto_get_parameter(baseProto, "color");
  mfProtoFields[7] = wb_supervisor_proto_get_parameter(baseProto, "string");
