...
int main(int argc, char **argv) {
  ...
  ts_assert_string_equal(wb_supervisor_field_get_name(NULL), "", "wb_supervisor_field_get_name(NULL) should return the empty string");
  ts_assert_int_equal(wb_supervisor_field_get_type(NULL), 0, "wb_supervisor_field_get_type(NULL) should return 0");
  ts_assert_string_equal(wb_supervisor_field_get_type_name(NULL), "", "wb_supervisor_field_get_type_name(NULL) should return the empty string");
