...
WEBOTS_CONTROLLER_C_RUNTIME=${WEBOTS_CONTROLLER_C_RUNTIME:-}
WEBOTS_CONTROLLER_CPP_RUNTIME=${WEBOTS_CONTROLLER_CPP_RUNTIME:-}
...
if [ -n "$WEBOTS_CONTROLLER_C_RUNTIME" ] && [ -f "$WEBOTS_CONTROLLER_C_RUNTIME" ]; then
  cp -f "$WEBOTS_CONTROLLER_C_RUNTIME" "$WEBOTS_CONTROLLER_LIB_PATH/Controller.dll"
fi
if [ -n "$WEBOTS_CONTROLLER_CPP_RUNTIME" ] && [ -f "$WEBOTS_CONTROLLER_CPP_RUNTIME" ]; then
  cp -f "$WEBOTS_CONTROLLER_CPP_RUNTIME" "$WEBOTS_CONTROLLER_LIB_PATH/CppController.dll"
fi
