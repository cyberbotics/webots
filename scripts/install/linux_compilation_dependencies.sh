...
apt update
apt install --yes git lsb-release cmake swig libglu1-mesa-dev libglib2.0-dev libfreetype6-dev libxml2-dev libboost-dev libssh-gcrypt-dev libzip-dev libreadline-dev pbzip2 libpci-dev wget zip unzip
