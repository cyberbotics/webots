...
`@laeerht`, Webots has several advantages compared to Gazebo, here is a non-exhaustive list:
...
##### laeerht 11/02/2019 00:48:58
how can i launch python controller in webots?

##### Stefania Pedrazzi [Cyberbotics] 11/04/2019 07:08:37
Hi `@laeerht`, usually controllers are automatically started by Webots when you run the simulation if the is used by any robot node, i.e. the Robot.controller field is set to your python controller name. Does this not work for you?
