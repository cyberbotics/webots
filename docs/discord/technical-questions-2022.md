...
##### Deleted User 03/26/2022 21:51:44
...
`@Deleted User` you have to set the correct environment variables
...
##### Deleted User 03/26/2022 22:51:18
...
##### Deleted User 03/26/2022 22:52:19
...
##### Deleted User 03/26/2022 22:58:09
yes
...
##### Deleted User 03/26/2022 22:58:49
and i use robot =
%figure
...
##### Deleted User 03/26/2022 23:01:01
oh
...
##### Deleted User 03/26/2022 23:01:30
...
##### Deleted User 03/26/2022 23:03:07
just got them
...
##### StringerBell 03/29/2022 18:46:08
...
##### StringerBell 03/30/2022 10:38:36
...
##### StringerBell 03/31/2022 17:47:32
...
##### StringerBell 03/31/2022 23:25:16
...
##### StringerBell 03/31/2022 23:54:16
...
##### StringerBell 04/01/2022 00:42:41
...
##### StringerBell 04/01/2022 01:05:50
...
##### StringerBell 04/01/2022 03:24:57
...
##### Deleted User 04/03/2022 19:49:39
...
##### Deleted User 08/15/2022 02:04:04
...
##### TheOnceBefore 09/21/2022 15:57:29
How do you add nodes like motors or sensors into your world?

##### Druthyn 09/21/2022 16:06:40
I have a python file I'm trying to use as a supervisor controller, but can't seem to initialise a supervisor inside the file.
...
This does as expected, prints Test 1 and Test 2, and then the console says the controller exited


But uncomment the line and nothing is printed and the controller doesn't exit


Any insights?


Potentially related to this error I am seeing a lot in console too


```[driver-5] Cannot open file: /tmp/webots-1234/WEBOTS_SERVER (retry count 46)
[driver-5] Cannot open file: /tmp/webots-1234/WEBOTS_SERVER (retry count 47)
```

##### AlexandrosNic 09/21/2022 17:27:16
I was running through some errors with my node, and now I verify it by using the official code found here: [https://docs.ros.org/en/foxy/Tutorials/Advanced/Simulators/Webots.html](https://docs.ros.org/en/foxy/Tutorials/Advanced/Simulators/Webots.html)

After creating a node (and adding it in the urdf), I receive this error when I start  the simulation: "AttributeError: 'MyRobotDriver' object has no attribute '\_MyRobotDriver\_\_node'"  even though. My class, as per the example, is named MyRobotDriver, and I should be able to access the node via self.\_\_node. Is it a python3.8 mistake?

##### Addy 09/22/2022 07:34:49
Hi Stefania, sorry a noob question here.



Im exploring the webots\_ros2 package atm



I look through the code of the turtlebot and tiago, but it is different from the tutorial of the ROS2 - Foxy because in that tutorial you have to create a custom plugin to control the robot.



but in the turtlebot and tiago, there is no user made plugin that does the control of the robot. 



I assume there's a webots made plugin that does the control?
...
``webots\_ros2\_control`` package

##### Rugnir 09/22/2022 08:55:11
Hi there, I have been having some issues following the tutorials for the new webots driver things, I followed [https://github.com/cyberbotics/webots\_ros2/wiki/Tutorial-Creating-a-Custom-Cpp-Plugin](https://github.com/cyberbotics/webots_ros2/wiki/Tutorial-Creating-a-Custom-Cpp-Plugin) and I do indeed end up with a library that builds, but that is it. 

It's incomplete? like the plugin does nothing, it doesn't say how to set up a launch file or anything like that to have the driver actually launch the plugin. it says you should make an xml file for pluginlib to see but I don't get how pluginlib would know to read that file



I tried following this one to make a launch file [https://github.com/cyberbotics/webots\_ros2/wiki/Tutorial-Creating-a-Custom-Package](https://github.com/cyberbotics/webots_ros2/wiki/Tutorial-Creating-a-Custom-Package) but it still doesn't appear to launch the plugin, I put cout and ros logging in the step function but they don't appear in either the webots console nor the launch terminal. I don't have a urdf file for the robot, it's a proto file instead, and I don't really want to have to export it and go through and add every single sensor to a webots tag or whatever



I just want to write an extern controller like before 😦

##### Florian 09/22/2022 09:11:09
I need some help with the LoopupTable of the Distance sensor. My actual LookupTable is this:
...
This is what Im getting from the DistanceSensor: 
...
field\_of\_view: 0.5235990285873413

min\_range: 0.0

max\_range: 0.25999999046325684

range: 0.4000000059604645



For me it seems like the lookupTable says, if i have a distance of 0.3 I will get a value of 0.3. But following the instructions of webots I should get a 16.0. Am I wrong there?


This is the instruction:
%figure
![unknown.png](https://cdn.discordapp.com/attachments/565154703139405824/1022435079466786826/unknown.png)
%end

##### Rugnir 09/22/2022 09:46:05
I guess its running on a different version of python than the one the c++ module is exported to

##### Florian 09/22/2022 09:48:27
I've made an instruction for what you need to install for myself. If you don't find the mistake I can send you that one this evening


I think I heard of this mistake, thats why I made the instruction 🙂


Which Module is missing?


Maybe send a Screenshot of your error

##### Rugnir 09/22/2022 09:51:58

%figure
![unknown.png](https://cdn.discordapp.com/attachments/565154703139405824/1022445143460155402/unknown.png)
%end


no module named webots\_ros2\_hircus\_cpp


thats the one defined in the urdf, like so 
```<webots>
       <plugin type="webots_ros2_hircus_cpp.Webots_Ros2_Hircus"/>
</webots>
```
...
##### Florian 09/22/2022 09:55:04
Maybe you should try another plugin or use your own

##### Rugnir 09/22/2022 09:55:15
?
...
thats what the tutorials both I and you sent are about

##### Florian 09/22/2022 09:58:24
Ah okay Im sorry my mistake. So the name of yours is webots\_ros2\_hircus\_cpp?

##### Rugnir 09/22/2022 09:58:32
yes

##### Florian 09/22/2022 10:00:52
And this is your driver? 'Webots\_Ros2\_Hircus'

##### Rugnir 09/22/2022 10:01:25
it's the name of the class
%figure
![unknown.png](https://cdn.discordapp.com/attachments/565154703139405824/1022447522171584542/unknown.png)
%end


might be that the noise bumped it down that far from 16.0

##### Florian 09/22/2022 10:04:03
I think your missing something. First you need the name of your package, then the name of the file and then the class name


<webots>

        <plugin type="my\_package.my\_robot\_driver.MyRobotDriver" />

    </webots>

##### Rugnir 09/22/2022 10:04:48
I had originally had it as webots\_ros2\_hircus\_cpp.webots\_ros2\_hircus\_cpp.Webots\_Ros2\_Hircus like that


it didn't work


whatever is after the module doesn't really matter because it can't find the module

##### Florian 09/22/2022 10:06:42
So you have a folder inside your workspace that is called webots\_ros2\_hircus\_cpp and inside of this folder there is a file webots\_ros2\_hircus\_cpp and inside this file is a class Webots\_Ros2\_Hircus


?


Maybe you should try to build this exactly like the tutorial, like same names etc. And take a look, if this works

##### Rugnir 09/22/2022 10:10:36
it's pointless to do it that way because the tutorial is in python


and again, I can import the package just fine in regular python
%figure
![unknown.png](https://cdn.discordapp.com/attachments/565154703139405824/1022450079606517840/unknown.png)
%end


the issue is that webots is launching it's driver with a different version of python than the one that the launch file and the system uses


the c++ file in which that error is thrown


on line 51


it's not exactly a solution but maybe it can help you figure it out

##### AlexandrosNic 09/22/2022 16:46:02
But then I have another problem with webots\_ros2, which is probably a bug. I run my environment, with some nodes running on the background. I don't run the nodes as a webots plugin through urdf, since this is not working as I mentioned above. Whenever I run a moveit2 action client, this is blocked and is doesn't execute. I believe that it has to do with threading or callbacks handling being blocked by the other nodes. When I don't run other nodes, moveit action client works just fine. I will also post it on github

##### CocytusDEDI 09/22/2022 16:48:30
hello i recently downloaded the simulator, i was wondering if there is any beginner code for python i could look at to get started

##### AlexandrosNic 09/22/2022 16:53:39
To reproduce the error with a minimum setup, I ran the moveit\_demo\_launch.py from the webots\_ros2\_universal\_robot package. For the moveit action client, I ran the pymoveit2: [https://github.com/AndrejOrsula/pymoveit2/tree/67f455fad35af0b69c4f754f1311175ac00cb7b0](https://github.com/AndrejOrsula/pymoveit2/tree/67f455fad35af0b69c4f754f1311175ac00cb7b0) , since I needed python. Then I created a simple node that uses the supervisor, and spin it. This resulted for my moveit client to stop working, specifically because it couldnt find the joint\_trajectory\_controller/follow\_joint\_trajectory service anymore. My simple node is:
...
##### Angel Sylvester 09/22/2022 20:16:57
Hello, I am attempting to use webots in headless mode on a supercomputer. However, when I follow the following commands ([https://cyberbotics.com/doc/guide/starting-webots-remotely-ssh](https://cyberbotics.com/doc/guide/starting-webots-remotely-ssh)), I get an error while loading shared libraries: libQt6Core.so.6: cannot open shared object file: No such file or directory. Any insights on why I am seeing this?

##### AlexandrosNic 09/23/2022 07:57:23
could it have to do with the fact that I didn't include my node in the urdf as a Webots plugin, and start it manually via ros2 run instead?

##### Rugnir 09/23/2022 09:21:53
I have exhausted every tutorial on the web to do with pluginlib and plugins but I still have no idea why webots\_ros2\_driver absolubtely refuses to find a basic c++ plugin 😦 [https://discord.com/channels/565154702715518986/1022430856310173756](https://discord.com/channels/565154702715518986/1022430856310173756)


really doesn't help that "rospack plugins" doesn't work in ros2 so I have no way of listing whether it is being exported successfully

##### Druthyn 09/23/2022 10:02:35
I'm having real difficulty getting a simulation running with multiple turtlebot3s and a supervisor, I think specifically tripping up on the integration of webots and ROS2. Anyone able to answer some more specific questions/have some really solid links I could follow/read through?

##### Mayuresh 09/26/2022 10:33:02
Can anybody help me with setting up a code in python for receivers and emitters for an epuck? I am facing difficulty (errors) in my code for emitters in the 'emitter' function code.
%figure
![Screenshot_2022-09-26_at_12.32.47_PM.png](https://cdn.discordapp.com/attachments/565154703139405824/1023905030631346256/Screenshot_2022-09-26_at_12.32.47_PM.png)
%end

##### Rugnir 09/27/2022 08:53:08
I see you made a message and packed it but you didn't send that, you tried to send the string "message" instead

##### kimmcg 09/27/2022 11:56:13
hi! Want to install the latest release from webots-ros2 but seems like for both Ubuntu 20.04 and 22.04 the latest release apt-get sees is still 1.2.3 and not 2022.1.0. It seems indeed that it's still in the package list as 1.2.3 ([http://packages.ros.org/ros2/ubuntu/dists/jammy/main/binary-amd64/Packages](http://packages.ros.org/ros2/ubuntu/dists/jammy/main/binary-amd64/Packages)) so I guess we might need to wait a bit longer until available? How long does that usually take in your experience

##### Olivier Michel [Cyberbotics] 09/27/2022 12:00:51
You can work with package 1.2.3. We recently tested it on Ubuntu 22.04 with ROS 2 Humble and it works fine. We will update to 2022.1.0 as soon as possible, but we may not be able to jump on the next sync scheduled this week, so I would say it should be there in a couple of weeks or so.

##### kimmcg 09/27/2022 12:56:56
ah oke! no worries I'll try it out from source then. I wanted to try it out with 2022b release, but that doesn't work with 1.2.3 since I get the 2022a warning. But then I have a sense of the timeline a bit. Thanks!

##### Florian 09/27/2022 14:47:17
Hey there. Can I change the LookupTable of a distance sensor? Because right now Im getting Feedback when Im closer than 0.4 Meters. I want to get a Feedback from about 5 Meters. Has someone experience with this?


Or does this depend on the sensor?

##### Addy 09/28/2022 03:52:41
what does this plugin do specifically?
%figure
![unknown.png](https://cdn.discordapp.com/attachments/565154703139405824/1024529055388803122/unknown.png)
%end

##### Din96\_Boy 09/28/2022 03:57:17
Hello Everyone, I'm new to working with Webots with ROS2. I'm using the latest version of Webots and following this tutorial [https://docs.ros.org/en/humble/Tutorials/Advanced/Simulators/Webots.html](https://docs.ros.org/en/humble/Tutorials/Advanced/Simulators/Webots.html) I followed this tutorial exactly but in my Webots, It shows this error. When I sent a command to move the robot in a new terminal, the message gets published but the robot did not move. Is there any way to resolve this issue? Thank you!
%figure
![errorcap1.PNG](https://cdn.discordapp.com/attachments/565154703139405824/1024530212194635856/errorcap1.PNG)
%end

##### Florian 09/28/2022 07:02:18
You should get Webots 2022a


Sorry for asking again.. has someone an example for a distance sensor of about 5 meters? I have problems to change the lookupTable the correct way

##### Benjamin Délèze [Cyberbotics] 09/28/2022 09:30:24
You can read more about lookupTable here: [https://cyberbotics.com/doc/reference/distancesensor#lookup-table](https://cyberbotics.com/doc/reference/distancesensor#lookup-table)

A distance sensor with the following lookupTable will return value 1024 when an object is at distance 0 and value 0 when the object is at 5 meters or more, with no noise. Values between the two will be linearly interpolated.
...
##### Florian 09/28/2022 09:34:53
Yes I already tried this, but when I change the LookupTable for myself it doesnt work the way I wanted it to

##### SunnyDelight 09/28/2022 13:53:22
Hello everyone,



I am thinking about collecting data for a project using the crazyflie 2.1 using the webots simulation. For this I would need to build a custom sensor (maybe reusing some code from the DistanceSensor) that simulates this multi zone ToF sensor here:



[https://github.com/ETH-PBL/Matrix\_ToF\_Drones](https://github.com/ETH-PBL/Matrix_ToF_Drones)



Has someone ever built a custom sensor and could elaborate a bit on how feasible this idea is?
...
Thank you very much for the quick answer! Would it be possible to create a custom sensor, or would you just use an arra yof 8x8 DIstanceSensors to model the ToF sensor?

##### Olivier Michel [Cyberbotics] 09/28/2022 14:23:33
No, it is possible (and recommended) to create a new sensor as a PROTO file.


If the measurement is an array of 8x8 distance sensors, another option would be to use a RangeFinder as a based node (instead of a DistanceSensor).


You may take inspiration from these PROTO to create yours: [https://www.cyberbotics.com/doc/guide/distancesensor-sensors](https://www.cyberbotics.com/doc/guide/distancesensor-sensors)


[https://www.cyberbotics.com/doc/guide/range-finder-sensors](https://www.cyberbotics.com/doc/guide/range-finder-sensors)


[https://github.com/cyberbotics/webots/tree/master/projects/devices/sharp/protos](https://github.com/cyberbotics/webots/tree/master/projects/devices/sharp/protos)

##### SunnyDelight 09/28/2022 14:45:14
Thank you very much for the quick help `@Olivier Michel`

##### Florian 09/29/2022 09:18:17
Hi there. I have a problem with the Distance Sensor, when Im moving an object it shows me about 4 Meters. When Im using my robot from the same distance the sensor shows me about 4 Meters. Does anyone knows how this could be?
...
##### SunnyDelight 09/29/2022 09:38:58
`@Olivier Michel` Is it possible to sse the implementation of the RangeFinder base node? To see how the sensor is modeled?

##### AlexandrosNic 09/29/2022 11:22:59
Hey. I'm tryin to create a link between two objects, with a Connector node, to simulate a vacuum gripper. I set the model, the type (active for the gripper, passive for the objects), the distance-axis-rotation tolerance, but still is not working. Any idea why?
%figure
![unknown.png](https://cdn.discordapp.com/attachments/565154703139405824/1025004765664518194/unknown.png)
%end

## October

##### globster 10/01/2022 23:23:56
Hey all, massive beginner here. Currently I'm going through the official tutorials and I came across this code:
...
Works just fine, but I'm wondering if anyone can explain what's going on in layman's terms? 



I'm pretty new to programming as well and this is the first time I've encountered pointers (I THINK these are pointers?) and that weird asterisk in the first declaration.



Any help?

##### Superfish57 10/01/2022 23:27:02
Hey there, I think I can help. I don't know much about webots, but I can hopefully get you pointed (heh) in the right direction about pointers.


I'm going to try and throw out an analogy. If you have question please interrupt me


The memory in your computer can be seen as a long series of boxes. Inside each box you can put a value. For example lets say the number 42.


Each of these boxes also has a numbered label on the front. Starting from zero and going up from there
...
The computer picks a box for you and puts your value, 42, inside of it for you


I imagine so far this has been pretty familiar


A pointer, in this box analogy world, is the number on the front of a box


So, lets say for example that your 42 got put into box 532


The pointer to foo is just the number 532


Hopefully that helps give you an intuition of what a pointer is, in a somewhat simplified way? If so I can move on to what the `*` and `->` are doing


Awesome! One quick question though, have you used structs yet?


In the meantime I'll explain the first line. The `*` character is telling the computer that this variable is actually a pointer to the type


`int foo;` is just a normal integer.

`int *bar;` is a pointer to a normal integer.


In your example, `Motor` is the type, the `*` tells us this is a pointer to that type, and the `[4]` tells us this is an array of 4 of these objects.

So `wheels` is an array of pointers to `Motor`s.


The second line is just an array of strings that hold the names of our 4 motors.


Ok cool, I'll throw a quick struct explanation in here


Structs can be used to group multiple pieces of information into one variable. For example lets take a look at a simple vector with 2 components, x and y.


The naive way of doing it might be as follows
...
This is fine enough when your code is simple, but lets try adding two points
...
Hopefully its' obvious why this isn't ideal


Instead, let's try using a struct to group x and y together
...
Using structs we made the structure of our code a bit more understandable


`Motor`, from your example, is just a struct


Ok now we are going to jump back into pointerville


Look back at my struct example and look at how I accessed x and y.


The pattern is `variable_name.element_name`


When we have a pointer to a struct, you have to do `variable_name->element_name`


so going back to your example, let's look at what the `for` loop is doing


and oopsies I made a mistake


It looks like your code example is c++, I mistakenly thought it was just c. `Motor` is probably a class instead of a struct. For now I'm going to ignore that and continue on since it doesn't matter too much for answering your question


~~The take away though, is one of `Motor`'s members is a function, instead of just a normal variable.~~


~~That function is `getMotor()`~~


You know what ignore all that, I made a double dumb mistake


We'll get there eventually


robot is the class that has a member function called `getMotor()`


Without looking at the documentation, it looks like `getMotor` takes a string (the motor's name) and returns a pointer to the motor with that name.


And now the answer to your original question. The code 

1. Creates an array of `Motor` pointers

2. Defines an array of motor names

3. Loops through each motor name, calls `getMotor()` to receive a `Motor` pointer, then sticks that pointer in our array of pointers


Hopefully that was somewhat helpful. If anyone else has been lurking, please feel free to roast me wherever I messed up

##### globster 10/02/2022 00:04:57
Thank you so much! Swamped with other stuff to read everything in-depth, but I'll be back with any questions if I have any 😊

##### Superfish57 10/02/2022 00:05:13
No problem, good luck!

##### Mayuresh 10/03/2022 09:34:25
does anyone know why webots using python gives the error "No module named 'numpy' " even when I have dowloaded numpy library?
%figure
![Screenshot_2022-10-03_at_11.33.00_AM.png](https://cdn.discordapp.com/attachments/565154703139405824/1026426992112975883/Screenshot_2022-10-03_at_11.33.00_AM.png)
%end
%figure
![Screenshot_2022-10-03_at_11.34.14_AM.png](https://cdn.discordapp.com/attachments/565154703139405824/1026426992654045204/Screenshot_2022-10-03_at_11.34.14_AM.png)
%end

##### Addy 10/03/2022 10:00:02
Hi everyone, according to slam toolbox documentation, **odometry/odom topic is required for SLAM, 

**

but when I check the RQT graph of Tiago Bot in Webots Ros2 Package, the ``/odom`` topic published by the ``diffdrive\_controller node ``**doesn't seem to be connected **with the ``slam toolbox node.``
%figure
![unknown.png](https://cdn.discordapp.com/attachments/565154703139405824/1026433439358009404/unknown.png)
%end



%figure
![ddasdsad.jpg](https://cdn.discordapp.com/attachments/565154703139405824/1026433963834748978/ddasdsad.jpg)
%end

##### DepressedCoder 10/03/2022 16:14:51
I am getting the following error on trying to use CrazyFlie. `@kimmcg` `@Olivier Michel`
%figure
![Screenshot_2022-10-03_at_9.39.40_PM.png](https://cdn.discordapp.com/attachments/565154703139405824/1026527766776127648/Screenshot_2022-10-03_at_9.39.40_PM.png)
%end

##### SunnyDelight 10/04/2022 09:58:05
Hey everyone, I have 2 questions:

1. Where can I find the motion editor in webots

2. I would like to provide the robot "crazyflie" robot with a path (motion file?) from point A to point B by only commanding forward velocity and yaw rate. (fixed height and zero sideways velocity). How would you go about this? I thought I need to get the information about the world (maybe a 2d horizontal slice at the fixed height) into my python script and then run a classical path/motion planning algorithm? Any ideas?

##### arijit 10/04/2022 21:33:33
can anyone please help me out in showing a case on webots where bug 0 algorithm fails

##### Florian 10/05/2022 10:58:08
Can I scale the distance sensor? Didn´t found something for that. Problem is that I´m using the surveyor with laser distance sensor. But It´s too small, thats why I scaled it with scale 7 7 7. But now the distance sensor is scaled too, but I need the real distance
