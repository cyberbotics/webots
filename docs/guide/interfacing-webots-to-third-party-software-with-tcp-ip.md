...
The simulated Khepera robot is controlled by the "[tcpip](https://github.com/omichel/webots/blob/master/projects/robots/k-team/khepera1/controllers/tcpip)" controller which is in the "controllers" directory of the same project.
