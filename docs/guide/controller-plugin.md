...
3. They will be displayed on your system default web browser unless you specify a different web browser in the [Webots preferences](preferences.md#web-services).
...
If you double click on the robot, your `<robot window name>` will open in your web browser.
