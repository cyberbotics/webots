...
![robotis_op3_motion_player.wbt.png](images/robots/robotis-op3/robotis_op3_motion_player.wbt_thumbnail.jpg) In this example, the ROBOTIS OP3 robot plays successively motions loaded from the ROBOTIS OP3 motion file of the real robot.
