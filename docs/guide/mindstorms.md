...
![rover.wbt.png](images/robots/mindstorms/rover.wbt_thumbnail.jpg) In this example you can see the Mindstorms Rover robot following a black line drawn on the ground.
