...
![pioneer2.wbt.png](images/robots/pioneer2/pioneer2.wbt_thumbnail.jpg) In this example, you can see a Pioneer 2 robot moving inside an arena while avoiding the walls.
