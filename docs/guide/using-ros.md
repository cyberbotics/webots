...
A [second more complicated example](https://github.com/cyberbotics/webots/tree/master/projects/robots/universal_robots/controllers/universal_robots_ros) shows how to interface a model of the Universal Robots arm model in Webots with ROS using [rospy](http://wiki.ros.org/rospy).
