...
To test MATLAB in Webots, start Webots and open the "WEBOTS\_HOME/projects/languages/matlab/worlds/e-puck\_matlab.wbt" or "[WEBOTS\_HOME/projects/robots/softbank/nao/worlds/nao\_matlab.wbt](https://github.com/cyberbotics/webots/tree/{version}/projects/robots/softbank/nao/worlds/nao_matlab.wbt)" world file.
