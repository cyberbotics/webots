...
4. Follow the path "[WEBOTS\_HOME/projects/default/worlds/textures/red\_brick\_wall.jpg](https://github.com/cyberbotics/webots/tree/released/projects/default/worlds/textures/red_brick_wall.jpg)". Normally it should be "/usr/local/webots/projects/default/worlds/textures/red\_brick\_wall.jpg". On a Mac, replace "/usr/local/webots" with "/Applications/webots.app".
