...
After that open "[config/simulation/local.json](https://github.com/cyberbotics/webots-server/blob/main/config/simulation/local.json)" and modify the following line with the path to your Webots installation:
```
