...
```
> **File location**: "[WEBOTS\_HOME/projects/robots/pal\_robotics/tiago++/protos/Tiago++.proto]({{ github_webots_home }}/projects/robots/pal_robotics/tiago++/protos/Tiago++.proto)"
...
You will find the following sample in this folder: "[WEBOTS\_HOME/projects/robots/pal\_robotics/tiago++/worlds]({{ github_webots_home }}/projects/robots/pal_robotics/tiago++/worlds)".
