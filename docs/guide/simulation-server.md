...
9. Install the [Compose plugin](https://docs.docker.com/compose/install/linux/) for docker if you want to run Webots simulation in dockers: `sudo apt-get install docker-compose-plugin`
