...
The world files for these examples are located in the "[WEBOTS\_HOME/projects/samples/rendering/worlds]({{ github_webots_home }}/projects/samples/rendering/worlds/)" directory.

In this directory, you will find the following world files:

### [animated\_skin.wbt]({{ github_webots_home }}/projects/samples/rendering/worlds/animated_skin.wbt)
...
### [physically\_based\_rendering.wbt]({{ github_webots_home }}/projects/samples/rendering/worlds/physically_based_rendering.wbt)
...
### [sponza.wbt]({{ github_webots_home }}/projects/samples/rendering/worlds/sponza.wbt)
