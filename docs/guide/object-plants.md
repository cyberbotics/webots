...
BunchOfSunFlowers {
  ...
  MFString   flowerTextureUrl       "webots://projects/objects/plants/protos/textures/bunch_of_sun_flowers_flower.png"
  MFString   leavesTextureUrl       "webots://projects/objects/plants/protos/textures/bunch_of_sun_flowers_leaves.png"
  SFNode     physics                NULL
}
```
...
PottedTree {
  ...
  MFString   potAndTreeTextureUrl "webots://projects/objects/plants/protos/textures/potted_tree_pot_and_tree.jpg"
  SFColor    leavesColor          1 1 1
  MFString   leavesTextureUrl     "webots://projects/objects/plants/protos/textures/potted_tree_leaves.png"
  SFNode     physics              NULL
}
```
