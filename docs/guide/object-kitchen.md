...
BiscuitBox {
  ...
  MFString   textureUrl  "webots://projects/objects/kitchen/breakfast/protos/textures/biscuit_box.jpg"
  SFFloat    mass        0.4
}
```
...
CerealBox {
  ...
  MFString   textureUrl  "webots://projects/objects/kitchen/breakfast/protos/textures/cereal_box_2.jpg"
  SFFloat    mass        1
}
```
...
HoneyJar {
  ...
  MFString   textureLidUrl  "webots://projects/objects/kitchen/breakfast/protos/textures/bee_lid.jpg"
  SFFloat    mass           0.5
...
JamJar {
  ...
  MFString   textureLidUrl "webots://projects/objects/kitchen/breakfast/protos/textures/blue_jar_lid.jpg"
  SFFloat    mass          0.5
}
```
...
HotPlate {
  ...
  MFString   textureUrl  "webots://projects/objects/kitchen/components/protos/textures/components.jpg"
}
```
...
Plate {
  ...
  SFRotation rotation    0 0 1 0
  SFString   name        "plate"
  MFString   textureUrl  "webots://projects/objects/kitchen/utensils/protos/textures/floral_plate.jpg"
  SFFloat    height      0.01
  SFFloat    radius      0.11
  SFFloat    mass        0.3
}
...
WoodenSpoon {
  ...
  MFString   textureUrl  "webots://projects/objects/kitchen/utensils/protos/textures/wooden_spoon.jpg"
}
```
