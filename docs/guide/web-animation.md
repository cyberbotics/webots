...
The [figure below](#screenshot-of-web-animation-pagea-generated-by-webots-with-(right)-and-without-(left)-css-styling) shows an example of an animation page generated by Webots. This animation is available [here](https://cyberbotics.com/animations/soccer_example/soccer.html).

%figure "Screenshot of Web animation pages generated by Webots with (right) and without (left) css styling"
