...
Can {
  ...
  SFString name "can"
  SFColor color 1 1 1
  MFString textureUrl "https://raw.githubusercontent.com/cyberbotics/webots/R2023a/projects/objects/drinks/protos/textures/can_base_color.jpg"
  SFFloat mass 0.35
}
```
...
WaterBottle {
  ...
  MFString   textureUrl  "https://raw.githubusercontent.com/cyberbotics/webots/R2023a/projects/objects/drinks/protos/textures/evian.png"
  SFFloat    mass        1
}
```
