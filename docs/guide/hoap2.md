...
![hoap2_sumo.wbt.png](images/robots/hoap2/hoap2_sumo.wbt_thumbnail.jpg) In this example, a HOAP-2 robot performs the Shiko dance (the dance sumos perform before a combat).
...
![hoap2_walk.wbt.png](images/robots/hoap2/hoap2_walk.wbt_thumbnail.jpg) In this example, a HOAP-2 robot walks straight forward on a tatami.
This robot is equipped with `TouchSensors` on the soles of its feet; it measures and logs the pressure exerted by its body on the ground.
