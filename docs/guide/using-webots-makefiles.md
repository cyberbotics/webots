...
You can find the available modules in the "[WEBOTS\_HOME/include/qt](https://github.com/omichel/webots/tree/master/include/)" directory (after running the Qt installation script).
