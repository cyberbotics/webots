...
- The **Thumbnail: Capture thumbnail on world save or share** checkbox allows a 768px by 432px (16:9) to be taken when the world is saved or exported. The thumbail is used during the loading process of the Webots [Web Interface](web-interface.md).
