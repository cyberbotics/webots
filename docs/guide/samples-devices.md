...
The "[WEBOTS\_HOME/projects/samples/devices](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/)" directory contains Webots worlds that individually demonstrate the Webots devices and their API.

The world files are located in the "[WEBOTS\_HOME/projects/samples/devices/worlds](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/)" directory, and their controllers in the "[WEBOTS\_HOME/projects/samples/devices/controllers](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/controllers/)" directory.
...
### [accelerometer.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/accelerometer.wbt)
...
### [battery.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/battery.wbt)
...
### [brake.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/brake.wbt)
...
### [bumper.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/bumper.wbt)
...
### [compass.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/compass.wbt)
...
### [camera.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/camera.wbt)
...
### [camera\_auto\_focus.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/camera_auto_focus.wbt)
...
### [camera\_motion\_blur.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/camera_motion_blur.wbt)
...
### [camera\_noise\_mask.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/camera_noise_mask.wbt)
...
### [camera\_recognition.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/camera_recognition.wbt)
...
### [connector.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/connector.wbt)
...
### [display.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/display.wbt)
...
It loads the [emoticons.png](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/controllers/display/emoticons.png) image which contains a grid of emoticons (as a sprite sheet), and randomly selects an emoticon from this image every 30 steps.
...
### [distance\_sensor.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/distance_sensor.wbt)
...
### [emitter\_receiver.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/emitter_receiver.wbt)
...
### [encoders.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/encoders.wbt)
...
### [force\_sensor.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/force_sensor.wbt)
...
### [force3d\_sensor.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/force3d_sensor.wbt)
...
### [gps.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/gps.wbt)
...
### [gyro.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/gyro.wbt)
...
### [hokuyo.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/hokuyo.wbt)
...
### [inertial\_unit.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/inertial_unit.wbt)
...
### [laser\_pointer.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/laser_pointer.wbt)
...
### [led.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/led.wbt)
...
### [lidar.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/lidar.wbt)
...
### [light\_sensor.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/light_sensor.wbt)
...
### [linear\_motor.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/linear_motor.wbt)
...
### [motor.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/motor.wbt)
...
### [motor2.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/motor2.wbt)
...
### [motor3.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/motor3.wbt)
...
### [pen.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/pen.wbt)
...
### [position\_sensor.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/position_sensor.wbt)
...
### [propeller.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/propeller.wbt)
...
### [radar.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/radar.wbt)
...
### [range\_finder.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/range_finder.wbt)
...
### [receiver\_noise.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/receiver_noise.wbt)
...
### [sick.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/sick.wbt)
...
### [sick\_point\_cloud.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/sick_point_cloud.wbt)
...
### [speaker.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/speaker.wbt)
...
### [speaker\_text\_to\_speech.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/speaker_text_to_speech.wbt)
...
### [spherical\_camera.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/spherical_camera.wbt)
...
### [supervisor.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/supervisor.wbt)
...
### [track.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/devices/worlds/track.wbt)
