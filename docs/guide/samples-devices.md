...
![accelerometer.png](images/samples/accelerometer.png) In this example, the robot turns on a slope.
...
![brake.png](images/samples/brake.png) In this example, a bike wheel turns until it is slowed down by a braking system.
...
![compass.png](images/samples/compass.png) In this example, `MyBot` moves in a closed arena filled with obstacles.
...
![display.png](images/samples/display.png) This example demonstrates several uses of the [Display](../reference/display.md) device.
...
![sick_point_cloud.png](images/samples/sick_point_cloud.png) Soda cans are transported on a conveyor belt.
