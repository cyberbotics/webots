...
Bed {
  ...
  SFNode     blanketAppearance  PBRAppearance { baseColorMap ImageTexture { url "webots://projects/objects/bedroom/protos/textures/duvet.jpg" } roughness 1 metalness 0 }
}
```
