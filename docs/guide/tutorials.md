...
The solutions of the tutorials are located into the [`WEBOTS_HOME/projects/samples/tutorials`](https://github.com/omichel/tree/master/webots/projects/samples/tutorials) subdirectory of the Webots installation directory.
