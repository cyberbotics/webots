...
The solutions of the tutorials are located into the "[WEBOTS\_HOME/projects/samples/tutorials](https://github.com/cyberbotics/webots/tree/{version}/projects/samples/tutorials)" subdirectory of the Webots installation directory.
