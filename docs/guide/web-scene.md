...
The `HTML5` page contains a Webots player which displays the `X3D` file as shown in the [figure below](#screenshot-of-web-scene-pages-generated-by-webots-with-and-without-css-styling).
...
%figure "Screenshot of Web scene pages generated by Webots with and without css styling""
