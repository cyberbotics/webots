...
You will find the corresponding ".wbt" files in the "[WEBOTS\_HOME/projects/samples/demos/worlds](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/demos/worlds)" directory, and their controller source code in the "[WEBOTS\_HOME/projects/samples/demos/controllers](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/demos/controllers)" directory.
For each demo, the world file and its corresponding controller have the same name.

### [anaglyph.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/demos/worlds/anaglyph.wbt)
...
### [gantry.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/demos/worlds/gantry.wbt)
...
### [hexapod.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/demos/worlds/hexapod.wbt)
...
### [moon.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/demos/worlds/moon.wbt)
...
### [soccer.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/demos/worlds/soccer.wbt)
...
### [stewart\_platform.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/demos/worlds/stewart_platform.wbt)
