...
You will find the corresponding ".wbt" files in the "[WEBOTS\_HOME/projects/samples/demos/worlds]({{ github_webots_home }}/projects/samples/demos/worlds)" directory, and their controller source code in the "[WEBOTS\_HOME/projects/samples/demos/controllers]({{ github_webots_home }}/projects/samples/demos/controllers)" directory.
For each demo, the world file and its corresponding controller have the same name.

### [anaglyph.wbt]({{ github_webots_home }}/projects/samples/demos/worlds/anaglyph.wbt)
...
### [gantry.wbt]({{ github_webots_home }}/projects/samples/demos/worlds/gantry.wbt)
...
### [hexapod.wbt]({{ github_webots_home }}/projects/samples/demos/worlds/hexapod.wbt)
...
### [moon.wbt]({{ github_webots_home }}/projects/samples/demos/worlds/moon.wbt)
...
### [soccer.wbt]({{ github_webots_home }}/projects/samples/demos/worlds/soccer.wbt)
...
### [stewart\_platform.wbt]({{ github_webots_home }}/projects/samples/demos/worlds/stewart_platform.wbt)
