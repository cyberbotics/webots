...
The world files for these examples are located in the "[WEBOTS\_HOME/sample/geometries/worlds](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/geometries/worlds/)" directory.

In this directory, you will find the following world files :

### [extended\_solids.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/geometries/worlds/extended_solids.wbt)
...
### [extrusion.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/geometries/worlds/extrusion.wbt)
...
### [floating\_geometries.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/geometries/worlds/floating_geometries.wbt)
...
### [geometric\_primitives.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/geometries/worlds/geometric_primitives.wbt)
...
### [high\_resolution\_indexedfaceset.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/geometries/worlds/high_resolution_indexedfaceset.wbt)
...
### [muscle.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/geometries/worlds/muscle.wbt)
...
### [physics\_primitives.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/geometries/worlds/physics_primitives.wbt)
...
### [polygons.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/geometries/worlds/polygons.wbt)
...
### [textured\_boxes.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/geometries/worlds/textured_boxes.wbt)
...
### [textured\_proto\_shapes.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/geometries/worlds/textured_proto_shapes.wbt)
...
### [textured\_shapes.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/geometries/worlds/textured_shapes.wbt)
...
### [webots\_box.wbt](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/projects/samples/geometries/worlds/webots_box.wbt)
