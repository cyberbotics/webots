...
The reflection factor is computed as follows: *f = 0.2 + 0.8 * red\_level * (1 - roughness) * (1 - 0.5 * occlusion)* where *red\_level* is the level of red color of the object hit by the sensor ray.
