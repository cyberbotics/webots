...
Released on XXX.
  ...
  - Enhancements
    ...
    - Improved webots console by supporting more [ANSI](https://en.wikipedia.org/wiki/ANSI_escape_code) escape codes, removing the controller name from its output and adding headers for the differents languages ([#1508](https://github.com/cyberbotics/webots/pull/1508)).
  - Dependency Updates
