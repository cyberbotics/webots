...
Released on XXX YYth, 2020.
  ...
  - Bug fixes
    ...
    - Fixed the [`camera/recognition_objects`](camera.md?tab-language=ros#wb_camera_recognition_get_objects) ros topic not published when the [`camera/image`](camera.md?tab-language=ros#wb_camera_recognition_get_objects) topic has no subscriber ([#2115](https://github.com/cyberbotics/webots/pull/2115)).
