...
Released on XXX.
  ...
  - New Features
    ...
    - Added the possibility to import [3D Studio mesh](https://wiki.fileformat.com/3d/3ds), [AutoCAD DXF](https://en.wikipedia.org/wiki/AutoCAD_DXF), [Blender](https://www.blender.org/), [Biovision Hierarchy](https://en.wikipedia.org/wiki/Biovision_Hierarchy), [Collada](https://en.wikipedia.org/wiki/COLLADA), [Filmbox](https://wiki.fileformat.com/3d/fbx/), [STEP](https://en.wikipedia.org/wiki/ISO_10303-21), [STL](https://en.wikipedia.org/wiki/STL_(file_format)), [Wavefront](hhttps://wiki.fileformat.com/3d/obj), [X3D](https://www.web3d.org/getting-started-x3d) files in Webots ([#1463](https://github.com/cyberbotics/webots/pull/1463)).
