...
Released on XXX.
  ...
  - New Features
    ...
    - Added the possibility to import [Blender](https://www.blender.org/), [Collada](https://en.wikipedia.org/wiki/COLLADA), [Wavefront](https://en.wikipedia.org/wiki/Wavefront_.obj_file) and [STL](https://en.wikipedia.org/wiki/STL_(file_format)) files in Webots ([#1463](https://github.com/cyberbotics/webots/pull/1463)).
