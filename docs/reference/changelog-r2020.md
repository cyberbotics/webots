...
Released on XXX.
  ...
  - New Features
    ...
    - Added the possibility to import [Blender](https://www.blender.org/), [Collada](https://en.wikipedia.org/wiki/COLLADA), [Filmbox](https://en.wikipedia.org/wiki/FBX), [STL](https://en.wikipedia.org/wiki/STL_(file_format)) and [Wavefront](https://en.wikipedia.org/wiki/Wavefront_.obj_file) files in Webots ([#1463](https://github.com/cyberbotics/webots/pull/1463)).
