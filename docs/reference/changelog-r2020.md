...
Released on XXX YYY, 2020.
  ...
  - Bug fixes
    - **Fixed cube, compact and flat texture mappings of [TexturedParallelepiped](object-geometries.md#texturedparallelepiped) proto** ([#2364](https://github.com/cyberbotics/webots/pull/2364)).
