...
Released on XXX YYY, 2020.
  ...
  - Bug fixes
    - Fixed cube, compact and flat texture mappings of [TexturedParallelepiped](https://cyberbotics.com/doc/guide/object-geometries#texturedparallelepiped) proto ([#2364](https://github.com/cyberbotics/webots/pull/2364)).
