...
A simple example is the "[WEBOTS\_HOME/projects/samples/howto/physics/worlds/physics.wbt]({{ github_webots_home }}/projects/samples/howto/physics/worlds/physics.wbt)" world.
...
The "[WEBOTS\_HOME/projects/robots/epfl/lis/worlds/blimp.wbt]({{ github_webots_home }}/projects/robots/epfl/lis/worlds/blimp.wbt)" shows how to suppress gravity, and apply a thrust force (propeller) for a blimp model.
