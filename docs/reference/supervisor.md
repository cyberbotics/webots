...
namespace webots {
  class Node {
    typedef enum {
      ...
      SLIDER_JOINT, SLOT, SOLID, SOLID_REFERENCE, TRACK, TRACK_WHEEL, TRANSMISSION_JOINT, WORLD_INFO, ZOOM
    } Type;
...
WB_NODE_TRACK, WB_NODE_TRACK_WHEEL, WB_NODE_TRANSMISSION_JOINT, WB_NODE_WORLD_INFO,
WB_NODE_ZOOM
