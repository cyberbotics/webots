...
x_y_z_array = wb_supervisor_field_get_mf_vec2f(field, index)
...
wb_supervisor_field_set_sf_vec2f(field, x_y_array)
wb_supervisor_field_set_sf_vec3f(field, x_y_z_array)
wb_supervisor_field_set_sf_rotation(field, x_y_z_alpha_array)
wb_supervisor_field_set_sf_color(field, r_g_b_array)
...
wb_supervisor_field_set_mf_vec2f(field, index, x_y_array)
wb_supervisor_field_set_mf_vec3f(field, index, x_y_z_array)
wb_supervisor_field_set_mf_rotation(field, index, x_y_z_a_array)
wb_supervisor_field_set_mf_color(field, index, r_g_b_array)
...
wb_supervisor_field_insert_mf_vec2f(field, index, x_y_array)
wb_supervisor_field_insert_mf_vec3f(field, index, x_y_z_array)
wb_supervisor_field_insert_mf_rotation(field, index, x_y_z_a_array)
wb_supervisor_field_insert_mf_color(field, index, r_g_b_array)
