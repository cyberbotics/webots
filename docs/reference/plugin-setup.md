...
If Webots does not find the file there, it will also look in the "[WEBOTS\_HOME/resources/projects/plugins/physics](https://github.com/cyberbotics/webots/tree/{{ setup.branch }}/resources/projects/plugins/physics)" directory.
