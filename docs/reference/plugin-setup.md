...
If Webots does not find the file there, it will also look in the "[WEBOTS\_HOME/resources/projects/plugins/physics]({{ github_webots_home }}/resources/projects/plugins/physics)" directory.
