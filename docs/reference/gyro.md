...
The `wb_gyro_get_lookup_table_size` function returns the size of the [lookup table](#lookup-table).

The `wb_gyro_get_lookup_table` function returns lookup table fields of the [lookup table](#lookup-table).
