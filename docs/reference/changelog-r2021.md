...
Released on June, Xth, 2021.
  ...
  - Enhancements
    - Added a `stadium_dry` [background](../guide/objects-backgrounds.md) with dry grass to allow Robocup players to distinguish the soccer field from the background ([#2874](https://github.com/cyberbotics/webots/pull/2874)).
