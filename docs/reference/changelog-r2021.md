...
Released on June, Xth, 2021.
  ...
  - New Samples:
    ...
    - Added a generic gear proto generator and a demo showing it being used in a collision-based transmission ([#2805](https://github.com/cyberbotics/webots/pull/2805)).
  - Bug fixes:
