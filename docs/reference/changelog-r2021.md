...
Released on XX Xth, 2021.
  ...
  - Bug fixes
    ...
    - Fixed the [Pen](pen.md) ink is mixed with the background and other ink when the `inkdensity` is lower than 1.0 ([#2804](https://github.com/cyberbotics/webots/pull/2804)).
  - Cleanup
