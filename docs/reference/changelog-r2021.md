...
Released on June, Xth, 2021.
  ...
  - New Samples:
    ...
    - Added a version of the [RobotisOp2](../guide/robotis-op2) modeled using [Hinge2Joint](hinge2joint.md) on the ankles, hips, and neck ([#2861](https://github.com/cyberbotics/webots/pull/2861)).
  - Bug fixes:
