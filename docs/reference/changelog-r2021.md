...
Released on June, Xth, 2021.
  ...
  - Enhancements
    ...
    - Added the `wb_supervisor_node_get_relative_pose` function that retrives a relative pose between two nodes ([#2932](https://github.com/cyberbotics/webots/pull/2932)).
  - New Samples:
