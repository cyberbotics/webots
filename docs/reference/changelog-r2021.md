...
Released on June, Xth, 2021.
  ...
  - Enhancements
    ...
    - Added the `wb_supervisor_node_get_pose` function that retrives an absolute pose or a pose between two nodes ([#2932](https://github.com/cyberbotics/webots/pull/2932)).
  - New Samples:
