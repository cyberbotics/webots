...
- Bug fixes:
  - Fixed mass computation after inserting a [Physics](physics.md) node in case the [Solid.boundingObject](solid.md)  was alrady defined ([#3240](https://github.com/cyberbotics/webots/pull/3240).
