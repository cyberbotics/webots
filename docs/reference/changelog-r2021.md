...
Released on XX, XXth, 2021.
  ...
  - Bug fixes:
    ...
    - Fixed getkey() of keyboard to not be executed during a robot_step for ROS and add a warning when robot battery is empty ([#3783](https://github.com/cyberbotics/webots/pull/3783)).
