...
Released on XX, XXth, 2021.
  ...
  - Enhancements
    ...
    - Added `wbu_driver_set_[right/left]_steering_angle` that allows to directly control the steering of the wheels ([#3933](https://github.com/cyberbotics/webots/pull/3933)).
  - Dependency Updates
