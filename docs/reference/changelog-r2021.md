...
Released on June, Xth, 2021.
  ...
  - Enhancements
    ...
    - Added the VRML97 [Billboard](billboard.md) node. A Billboard node contains children nodes that rotates automatically to face the users ([#3023](https://github.com/cyberbotics/webots/pull/3023)). 
  - New Samples:
