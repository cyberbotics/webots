...
Released on XX Xth, 2021.
  ...
  - Bug fixes
    - Fixed crash changing the [`Lidar.type`](lidar.md) field during the simulation run requiring to save and reload the world ([#2983](https://github.com/cyberbotics/webots/pull/2983)).
