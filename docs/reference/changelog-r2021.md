...
Released on June, Xth, 2021.
  ...
  - Enhancements
    - Added the `dragForceScale` and `dragTorqueScale` fields to [WorldInfo](worldinfo.md) which enable setting the order of magnitude of the force/torque to be applied in the interface ([#3174](https://github.com/cyberbotics/webots/pull/3174)).
