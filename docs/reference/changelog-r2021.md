...
Released on XX Xth, 2021.
  ...
  - Cleanup
    - Changed structure of the [projects/samples/howto]({{ github_webots_home }}/projects/samples/howto) directory, so each demonstration is in a dedicated directory ([#2639](https://github.com/cyberbotics/webots/pull/2639)).
