...
Released on ??
  - New Features
    ...
    - Added a model of the the ROSbot XL and the Husarion World from [Husarion](https://husarion.com/) and the example world ([#5973](https://github.com/cyberbotics/webots/pull/5973)).
  - Cleanup
