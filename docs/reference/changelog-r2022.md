...
Released on XX, XXth, 2022.
  ...
  - New Features:
    ...
    - Added the `wwiReceiveStrings` API function in Python that returns a list of all messages waiting in the reception buffer ([#4336](https://github.com/cyberbotics/webots/pull/4336)).
  - New Objects:
