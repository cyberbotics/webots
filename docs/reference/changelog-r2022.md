...
Released on XX, XXth, 2022.
  ...
  - New Features:
    ...
    - Added two new Robot API functions, `wb_robot_step_begin` and `wb_robot_step_end`, to optimize complex controllers ([#4107](https://github.com/cyberbotics/webots/pull/4107)).
