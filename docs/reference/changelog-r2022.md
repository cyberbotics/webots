...
Released on XX, XXth, 2022.
  ...
  - Added a [SCARA Epson T6](../guide/scara_epson_t6.md) PROTO and a demo showing it moving fruits in a food industry ([#4192](https://github.com/cyberbotics/webots/pull/4192).
  - Enhancements:
