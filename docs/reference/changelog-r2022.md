...
Released on XX XX, 2022.
  ...
  - Bug fixes
    ...
    - Fixed virtual reality and `get_contact_points` ROS services, and no longer advertise deprecated ones `get_number_of_contact_points`, `get_contact_point_node` and `get_contact_point_node`  ([#4371](https://github.com/cyberbotics/webots/pull/4371)).
