...
Released on XX XX, 2022.
  ...
  - Bug fixes
    ...
    - Fixed a situation where the joystick's release button status could not be obtained when using ros, and the POV data could not be read using the Int8Stamped type([#4401](https://github.com/cyberbotics/webots/pull/4401)).
