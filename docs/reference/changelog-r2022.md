...
Released on XX, XXth, 2022.
  ...
  - Added [SCARA Epson T6](../guide/scara_epson_t6.md) robot and a demo showing it sorting fruits in a food industry setting ([#4192](https://github.com/cyberbotics/webots/pull/4192).
  - Enhancements:
