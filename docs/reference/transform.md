...
Only non-zero values are permitted; zero values scale are automatically reset to 1.
Graphical objects support any non-zero non-uniform scale whereas physical objects are subjected to restrictions.
