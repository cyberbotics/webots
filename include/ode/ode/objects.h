...
/**
 * @brief Propagate the worlds parameters into clustered worlds.
 * @param The world whos parameters to propagate
 * @ingroup world
 */
ODE_API void dWorldRefreshParameters(dWorldID w);
...
ODE_API int dJointGroupGetCount(dJointGroupID);
...
/**
 * @brief Set hinge suspension axis.
 * @ingroup joints
 */
ODE_API void dJointSetHingeSuspensionAxis (dJointID, dReal x, dReal y, dReal z);
...
/**
 * @brief set suspension axis
 * @ingroup joints
 */
ODE_API void dJointSetHinge2SuspensionAxis (dJointID, dReal x, dReal y, dReal z);
...
/**
 * @brief Tell the LMotor what the current position is along axis anum.
 *
 * The position information is needed if stops have been set along the axis,
 * but it is not needed for axis motors.
 * @ingroup joints
 */
ODE_API void dJointSetLMotorPosition (dJointID, int anum, dReal position);
...
/**
 * @brief get suspension axis
 * @ingroup joints
 */
ODE_API void dJointGetHingeSuspensionAxis (dJointID, dVector3 result);
 ...
 * @ingroup joints
 */
ODE_API void dJointGetHinge2SuspensionAxis (dJointID, dVector3 result);
 ...
 * @ingroup joints
 */
ODE_API dReal dJointGetLMotorPosition (dJointID, int anum);
...
/**
 * @brief Utility function
 * @return 1 if the two geoms are duplicated from same
 * parent, otherwise return 0.
 * @ingroup geoms
 */
ODE_API int dAreGeomsSame (dGeomID, dGeomID);
