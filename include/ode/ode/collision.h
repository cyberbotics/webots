...
typedef int dWorldStepFunction(dWorldID, dReal);
typedef void dSpaceUpdateFunction(int threadID);
ODE_API void dSpaceCollideAndWorldStep (dSpaceID space, void *data, dNearCallback *callback, dWorldID world, dReal stepsize, dWorldStepFunction* _stepFunc);
ODE_API void dToggleODE_MT(int numThreads);
ODE_API void dWorldStepAndSpaceCollide (dSpaceID space, void *data, dNearCallback *callback, dWorldID world, dReal stepsize, dWorldStepFunction* _stepFunc, dSpaceUpdateFunction* _updateFunc);
