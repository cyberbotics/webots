...
bool WbReceiver::checkApertureAndRange(const WbEmitter *emitter, const WbReceiver *receiver, bool checkRangeOnly) const {
  ...
  if (emitter->aperture() > 0.0) {
    ...
    WbVector4 eAxisX4 = emitter->matrix().column(0);
    WbVector3 eAxisX3(eAxisX4[0], eAxisX4[1], eAxisX4[2]);
  ...
  if (receiver->aperture() > 0.0) {
    ...
    WbVector4 rAxisX4 = receiver->matrix().column(0);
    WbVector3 rAxisX3(rAxisX4[0], rAxisX4[1], rAxisX4[2]);
