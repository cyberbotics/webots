...
WbBasicHingeJoint::WbBasicHingeJoint(const QString &modelName, WbTokenizer *tokenizer) : WbJoint(modelName, tokenizer) {
}

WbBasicHingeJoint::WbBasicHingeJoint(WbTokenizer *tokenizer) : WbJoint("BasicHingeJoint", tokenizer) {
}

WbBasicHingeJoint::WbBasicHingeJoint(const WbBasicHingeJoint &other) : WbJoint(other) {
}

WbBasicHingeJoint::WbBasicHingeJoint(const WbNode &other) : WbJoint(other) {
}

WbBasicHingeJoint::~WbBasicHingeJoint() {
}

WbHingeJointParameters *WbBasicHingeJoint::hingeJointParameters() const {
  return dynamic_cast<WbHingeJointParameters *>(mParameters->value());
}

WbRotationalMotor *WbBasicHingeJoint::rotationalMotor() const {
...
void WbBasicHingeJoint::updateEndPointZeroTranslationAndRotation() {
...
void WbBasicHingeJoint::computeEndPointSolidPositionFromParameters(WbVector3 &translation, WbRotation &rotation) const {
  const WbVector3 &ax = axis().normalized();
...
bool WbBasicHingeJoint::setJoint() {
...
void WbBasicHingeJoint::setOdeJoint(dBodyID body, dBodyID parentBody) {
...
void WbBasicHingeJoint::applyToOdeMinAndMaxStop() {
  assert(mJoint);
...
void WbBasicHingeJoint::applyToOdeAxis() {
...
void WbBasicHingeJoint::applyToOdeSuspensionAxis() {
...
void WbBasicHingeJoint::applyToOdeAnchor() {
  assert(mJoint);
...
void WbBasicHingeJoint::applyToOdeSpringAndDampingConstants(dBodyID body, dBodyID parentBody) {
  const WbJointParameters *const p = parameters();
...
void WbBasicHingeJoint::applyToOdeSuspension() {
  // suspension along the suspension axis
  const WbHingeJointParameters *const hp = hingeJointParameters();
  if (hp == NULL)
    return;
...
void WbBasicHingeJoint::prePhysicsStep(double ms) {
...
void WbBasicHingeJoint::postPhysicsStep() {
  assert(mJoint);
  WbRotationalMotor *const rm = rotationalMotor();
...
void WbBasicHingeJoint::updatePosition() {
...
void WbBasicHingeJoint::updatePosition(double position) {
...
void WbBasicHingeJoint::updateParameters() {
  WbJoint::updateParameters();
  const WbHingeJointParameters *const p = hingeJointParameters();
  if (p) {
    connect(p, &WbHingeJointParameters::anchorChanged, this, &WbBasicHingeJoint::updateAnchor, Qt::UniqueConnection);
    connect(p, &WbHingeJointParameters::suspensionChanged, this, &WbBasicHingeJoint::updateSuspension, Qt::UniqueConnection);
  }
}

void WbBasicHingeJoint::updateSuspension() {
  if (isEnabled())
    applyToOdeSuspension();
}

void WbBasicHingeJoint::updateMinAndMaxStop(double min, double max) {
...
void WbBasicHingeJoint::updateAnchor() {
...
WbVector3 WbBasicHingeJoint::axis() const {
  static const WbVector3 DEFAULT_AXIS(1.0, 0.0, 0.0);
  const WbJointParameters *const p = parameters();
  return p ? p->axis() : DEFAULT_AXIS;
}

WbVector3 WbBasicHingeJoint::anchor() const {
  const WbHingeJointParameters *const p = hingeJointParameters();
  return p ? p->anchor() : WbBasicJoint::anchor();
}

void WbBasicHingeJoint::updateOdeWorldCoordinates() {
