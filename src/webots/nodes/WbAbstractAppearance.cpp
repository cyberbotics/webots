...
WbAbstractAppearance::WbAbstractAppearance(const WbNode *parentNode, const QString &modelName, const aiMaterial *material) :
  WbBaseNode(parentNode, modelName, material) {
