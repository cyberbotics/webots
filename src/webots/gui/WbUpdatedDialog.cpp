...
WbUpdatedDialog::WbUpdatedDialog(QWidget *parent) : QDialog(parent) {
  setWindowTitle(tr("Welcome to Webots R2025b"));
  ...
  label->setText(tr("<b>Thank you for using Webots R2025b.</b>"));
  ...
  label->setText(tr("Find out the new features, enhancements and bug fixes of Webots R2025b in the <a style='color: #5DADE2;' "
