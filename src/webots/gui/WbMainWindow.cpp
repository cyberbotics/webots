...
void WbMainWindow::show3DViewingInfo() {
  const QString info =
    tr("<strong>Rotate:</strong><br/>"
       ...
       "Dragging the mouse horizontally the camera will rotate about the world up axis. "
       "Dragging the mouse vertically the camera will rotate about its horizontal axis.<br/><br/>"
