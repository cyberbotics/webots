...
public:
  ...
  static void appendStdout(const QString &message, bool controllerMessage = false);
  static void appendStderr(const QString &message, bool controllerMessage = false);
