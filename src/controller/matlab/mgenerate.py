...
def main(args=None):
    ...
    generator.gen(FUNC, "wb_supervisor_node_disable_contact_points_tracking(noderef, include_descendants)", "supervisor")
    generator.gen(FUNC, "wb_supervisor_node_disable_contact_point_tracking(noderef, include_descendants)", "supervisor") # DEPRECATED
