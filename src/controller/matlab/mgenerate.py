...
def main(args=None):
    ...
    generator.gen(FUNC, "wb_supervisor_field_get_actual_parameter(fieldref)", "supervisor")
    ...
    generator.gen(FUNC, "wb_supervisor_node_get_number_of_parameters(noderef)", "supervisor")
    # generator.gen(FUNC, "wb_supervisor_node_get_orientation(noderef)", "supervisor")
    generator.gen(FUNC, "wb_supervisor_node_get_parameter(noderef, parametername)", "supervisor")
    generator.gen(FUNC, "wb_supervisor_node_get_parameter_by_index(noderef, parameterindex)", "supervisor")
    ...
    generator.gen(FUNC, "wb_supervisor_proto_get_number_of_parameters(protoref)", "supervisor")
    generator.gen(FUNC, "wb_supervisor_proto_get_parameter(protoref, parametername)", "supervisor")
    generator.gen(FUNC, "wb_supervisor_proto_get_parameter_by_index(protoref, parameterindex)", "supervisor")
