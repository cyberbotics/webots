...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'demo/a.out.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_demo/a.out.data');

      };
      Module['addRunDependency']('datafile_demo/a.out.data');
...
/** @type {function(...*):?} */
var _wr_viewport_set_clear_color_rgb2 = Module["_wr_viewport_set_clear_color_rgb2"] = createExportWrapper("wr_viewport_set_clear_color_rgb2");
