...
export default class ProtoManager {
  ...
  getXmlOfMinimalScene() {
    ...
    imageTexture.setAttribute('url', 'https://raw.githubusercontent.com/cyberbotics/webots/R2025b/projects/default/worlds/textures/grid.png');
