...
export default class WebotsView extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.toolbarCss.href = 'https://cyberbotics.com/wwi/R2025b/css/toolbar.css';
    ...
    this.progressCss.href = 'https://cyberbotics.com/wwi/R2025b/css/progress.css';
    ...
    script.textContent = `var Module = [];
        ...
        if (path.endsWith('.data'))
          return 'https://cyberbotics.com/wwi/R2025b/' + path;
  ...
  #init() {
    ...
    promises.push(this.#loadScript('https://cyberbotics.com/wwi/R2025b/dependencies/ansi_up.js'));
    promises.push(this.#loadScript('https://cyberbotics.com/wwi/R2025b/dependencies/assimpjs.js'));
    promises.push(this.#loadScript('https://cyberbotics.com/wwi/R2025b/dependencies/glm-js.min.js'));
    promises.push(this.#loadScript('https://cyberbotics.com/wwi/R2025b/dependencies/quaternion.min.js'));
    promises.push(this.#loadScript('https://cyberbotics.com/wwi/R2025b/dependencies/libtess.min.js'));
    promises.push(this.#loadScript('https://cyberbotics.com/wwi/R2025b/enum.js'));
    promises.push(this.#loadScript('https://cyberbotics.com/wwi/R2025b/wrenjs.js'));
  }
