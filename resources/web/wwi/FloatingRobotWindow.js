export default class FloatingRobotWindow {
  constructor(parentNode, name, window, url) {
    ...
    this.floatingRobotWindow.className = 'floating-robot-window';
    ...
    this.floatingRobotWindowHeader.className = 'floating-robot-window-header';
    this.floatingRobotWindow.appendChild(this.floatingRobotWindowHeader);

    this.headerText = document.createElement('p');
    this.headerText.className = 'floating-robot-window-text';
    ...
    this.headerQuit.className = 'floating-robot-window-close';
  ...
  dragElement(rw) {
    ...
    let pageHeight = rw.parentNode.parentNode.parentNode.offsetHeight;
    let containerHeight = rw.parentNode.parentNode.offsetHeight;
    let containerWidth = rw.parentNode.parentNode.offsetWidth;
