...
export default class WbWrenShaders {
  ...
  static simpleShader() {
    if (!WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_SIMPLE]) {
      ...
      _wr_shader_program_use_uniform(WbWrenShaders.SHADER.gShaders[WbWrenShaders.SHADER.SHADER_SIMPLE],
        Enum.WR_GLSL_LAYOUT_UNIFORM_TEXTURE0);
      _wr_shader_program_use_uniform(WbWrenShaders.SHADER.gShaders[WbWrenShaders.SHADER.SHADER_SIMPLE],
        Enum.WR_GLSL_LAYOUT_UNIFORM_MODEL_TRANSFORM);
      _wr_shader_program_use_uniform(WbWrenShaders.SHADER.gShaders[WbWrenShaders.SHADER.SHADER_SIMPLE],
      ...
      _wr_shader_program_use_uniform_buffer(WbWrenShaders.SHADER.gShaders[WbWrenShaders.SHADER.SHADER_SIMPLE],
        Enum.WR_GLSL_LAYOUT_UNIFORM_BUFFER_MATERIAL_PHONG);
      _wr_shader_program_use_uniform_buffer(WbWrenShaders.SHADER.gShaders[WbWrenShaders.SHADER.SHADER_SIMPLE],
        Enum.WR_GLSL_LAYOUT_UNIFORM_BUFFER_CAMERA_TRANSFORMS);

      WbWrenShaders.buildShader(WbWrenShaders.SHADER.gShaders[WbWrenShaders.SHADER.SHADER_SIMPLE],
        '../../../resources/wren/shaders/simple.vert', '../../../resources/wren/shaders/simple.frag');
    }

    return WbWrenShaders.SHADER.gShaders[WbWrenShaders.SHADER.SHADER_SIMPLE];
  }
}
