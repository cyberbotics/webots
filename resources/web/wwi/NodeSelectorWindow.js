...
export default class NodeSelectorWindow {
  ...
  #setupWindow(parentNode) {
    ...
    img.draggable = false;
    img.src = 'https://raw.githubusercontent.com/cyberbotics/webots/R2025b/resources/images/missing_proto_icon.png';
  ...
  populateNodeInfo(nodeName) {
    ...
    if (typeof nodeName === 'undefined') {
      ...
      nodeImage.onerror = () => {
        ...
        nodeImage.src = 'https://raw.githubusercontent.com/cyberbotics/webots/R2025b/resources/images/missing_proto_icon.png';
      };
