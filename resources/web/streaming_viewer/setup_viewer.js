...
if (mobileDevice) {
  ...
  mobileCss.setAttribute('href', 'https://www.cyberbotics.com/wwi/R2025b/css/wwi_mobile.css');
...
function connect() {
  const defaultThumbnail = 'https://cyberbotics.com/wwi/R2025b/images/loading/default_thumbnail.png';
